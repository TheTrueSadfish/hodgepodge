...
const u8 *const gMonIconTable[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_GOOPER] = gMonIcon_QuestionMark,
    [SPECIES_SWISQUIRE] = gMonIcon_Swisquire,
    [SPECIES_MOG] = gMonIcon_QuestionMark,
    [SPECIES_PROFUR] = gMonIcon_Profur,
    [SPECIES_CELSHRIOOM] = gMonIcon_Celshrioom,
    [SPECIES_DADALEMMA] = gMonIcon_Dadalemma,
    [SPECIES_CRAWTENDR] = gMonIcon_Crawtendr,
    [SPECIES_OKKAMIRIZO] = gMonIcon_Okkamirizo,
    [SPECIES_PLANTATORI] = gMonIcon_Plantatori,
    [SPECIES_SAPPOD] = gMonIcon_QuestionMark,
    [SPECIES_SHELBERT] = gMonIcon_QuestionMark,
    [SPECIES_SHELEBRATE] = gMonIcon_Shelebrate,
    [SPECIES_SNORT_ALPACA] = gMonIcon_SnortAlpaca,
    [SPECIES_PLAINTAIN] = gMonIcon_QuestionMark,
    [SPECIES_MUSALORD] = gMonIcon_Musalord,
    [SPECIES_BREVATO] = gMonIcon_Brevato,
    [SPECIES_KELPPY] = gMonIcon_QuestionMark,
    [SPECIES_LURKELP] = gMonIcon_Lurkelp,
    [SPECIES_SHROOMOINK] = gMonIcon_QuestionMark,
    [SPECIES_SPORKE] = gMonIcon_QuestionMark,
    [SPECIES_CHERNOBOAR] = gMonIcon_Chernoboar,
    [SPECIES_BURSTAD] = gMonIcon_QuestionMark,
    [SPECIES_BLASTOAD] = gMonIcon_QuestionMark,
    [SPECIES_EXPLOAD] = gMonIcon_Expload,
    [SPECIES_FBI_PENGUIN_1] = gMonIcon_QuestionMark,
    [SPECIES_FBI_PENGUIN_2] = gMonIcon_QuestionMark,
    [SPECIES_ICANDESFEN] = gMonIcon_Icandesfen,
    [SPECIES_MAGIDASH] = gMonIcon_Magidash,
    [SPECIES_SERAPHURE] = gMonIcon_Seraphure,
    [SPECIES_HAGOOSH] = gMonIcon_Hagoosh,
    [SPECIES_WAKASUKA] = gMonIcon_Wakasuka,
    [SPECIES_DULLSOD] = gMonIcon_QuestionMark,
    [SPECIES_BEVOLPIN] = gMonIcon_Bevolpin,
    [SPECIES_WATTL] = gMonIcon_QuestionMark,
    [SPECIES_XOLHM] = gMonIcon_Xolhm,
    [SPECIES_ODDIOWAVE] = gMonIcon_Oddiowave,
    [SPECIES_WHERML] = gMonIcon_QuestionMark,
    [SPECIES_CRUSTERROR] = gMonIcon_Crusterror,
    [SPECIES_MANTACORE] = gMonIcon_Mantacore,
    [SPECIES_SKULDUGERY] = gMonIcon_Skuldugery,
    [SPECIES_GRAVENDOR] = gMonIcon_Gravendor,
    [SPECIES_OGWON_ROCK] = gMonIcon_OgwonRock,
    [SPECIES_GRUBBLE] = gMonIcon_QuestionMark,
    [SPECIES_GRACKLIN] = gMonIcon_Gracklin,
    [SPECIES_SHAMBURGER] = gMonIcon_Shamburger,
    [SPECIES_FROZHORN] = gMonIcon_QuestionMark,
    [SPECIES_FROZFORCE] = gMonIcon_Frozforce,
    [SPECIES_STAALNARY] = gMonIcon_Staalnary,
    [SPECIES_BAROMITE] = gMonIcon_QuestionMark,
    [SPECIES_NAPALMITE] = gMonIcon_QuestionMark,
    [SPECIES_STOVLARE] = gMonIcon_Stovlare,
    [SPECIES_ORBACLE] = gMonIcon_Orbacle,
    [SPECIES_NINOWN] = gMonIcon_Ninown,
    [SPECIES_CARDICT] = gMonIcon_QuestionMark,
    [SPECIES_POKERLORD] = gMonIcon_Pokerlord,
    [SPECIES_DEGOURGE] = gMonIcon_Degourge,
    [SPECIES_TUETUERROR] = gMonIcon_Tuetuerror,
    [SPECIES_BAGHOST] = gMonIcon_QuestionMark,
    [SPECIES_BAGHOUL] = gMonIcon_Baghoul,
    [SPECIES_WUVME] = gMonIcon_Wuvme,
    [SPECIES_VEEBLEN] = gMonIcon_QuestionMark,
    [SPECIES_MALACHREY] = gMonIcon_Malachrey,
    [SPECIES_MALMARE] = gMonIcon_Malmare,
    [SPECIES_SWEETAN] = gMonIcon_QuestionMark,
    [SPECIES_MELCERALBA] = gMonIcon_Melceralba,
    [SPECIES_BUGGORY] = gMonIcon_Buggory,
    [SPECIES_ZAPPUG] = gMonIcon_QuestionMark,
    [SPECIES_PUPULZE] = gMonIcon_QuestionMark,
    [SPECIES_RUBIMIZER] = gMonIcon_Rubimizer,
    [SPECIES_RICKSHAWTY] = gMonIcon_Rickshawty,
    [SPECIES_TREMITE] = gMonIcon_QuestionMark,
    [SPECIES_TROHIVE] = gMonIcon_QuestionMark,
    [SPECIES_CASTERMITE] = gMonIcon_Castermite,
    [SPECIES_EYESLIGHT] = gMonIcon_QuestionMark,
    [SPECIES_BEHOLZER] = gMonIcon_Beholzer,
    [SPECIES_EYERISH] = gMonIcon_QuestionMark,
    [SPECIES_RETINEEL] = gMonIcon_QuestionMark,
    [SPECIES_ASTIGMORAY] = gMonIcon_Astigmoray,
    [SPECIES_GELECTUAL] = gMonIcon_Gelectual,
    [SPECIES_REBRR] = gMonIcon_QuestionMark,
    [SPECIES_FERROFROS] = gMonIcon_QuestionMark,
    [SPECIES_FORTIFROS] = gMonIcon_Fortifros,
    [SPECIES_ARCTIKACK] = gMonIcon_Arctikack,
    [SPECIES_PRISMAPUP] = gMonIcon_QuestionMark,
    [SPECIES_VIVIDAWG] = gMonIcon_Vividawg,
    [SPECIES_KITTEPUP] = gMonIcon_Kittepup,
    [SPECIES_PECKACHEW] = gMonIcon_Peckachew,
    [SPECIES_SKOOKY] = gMonIcon_Skooky,
    [SPECIES_VIZAAVISO] = gMonIcon_Vizaaviso,
    [SPECIES_SETATONKRE] = gMonIcon_Setatonkre,
    [SPECIES_PANZEEHEE] = gMonIcon_QuestionMark,
    [SPECIES_BABOBO] = gMonIcon_Babobo,
    [SPECIES_GROOSE] = gMonIcon_QuestionMark,
    [SPECIES_GREESE] = gMonIcon_Greese,
#endif
    ...
    [SPECIES_HAGOOSH_VISCOUS] = gMonIcon_HagooshViscous,
    [SPECIES_ASTIGMORAY_BLIND] = gMonIcon_AstigmorayBlind,
    [SPECIES_RICKSHAWTY_CHARIOT] = gMonIcon_RickshawtyChariot,
    [SPECIES_MALMARE_VIRUS] = gMonIcon_MalmareVirus,
#endif
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_MOG] = 0,
    [SPECIES_PROFUR] = 0,
    [SPECIES_CELSHRIOOM] = 2,
    [SPECIES_DADALEMMA] = 3,
    [SPECIES_CRAWTENDR] = 0,
    [SPECIES_OKKAMIRIZO] = 2,
    [SPECIES_PLANTATORI] = 2,
    [SPECIES_SAPPOD] = 0,
    [SPECIES_SHELBERT] = 0,
    [SPECIES_SHELEBRATE] = 4,
    [SPECIES_SNORT_ALPACA] = 0,
    [SPECIES_PLAINTAIN] = 0,
    [SPECIES_MUSALORD] = 1,
    [SPECIES_BREVATO] = 1,
    [SPECIES_KELPPY] = 0,
    [SPECIES_LURKELP] = 0,
    [SPECIES_SHROOMOINK] = 0,
    [SPECIES_SPORKE] = 0,
    [SPECIES_CHERNOBOAR] = 0,
    [SPECIES_BURSTAD] = 0,
    [SPECIES_BLASTOAD] = 0,
    [SPECIES_EXPLOAD] = 1,
    [SPECIES_FBI_PENGUIN_1] = 0,
    [SPECIES_FBI_PENGUIN_2] = 0,
    [SPECIES_ICANDESFEN] = 0,
    [SPECIES_MAGIDASH] = 3,
    [SPECIES_SERAPHURE] = 3,
    [SPECIES_HAGOOSH] = 0,
    [SPECIES_WAKASUKA] = 1,
    ...
    [SPECIES_ODDIOWAVE] = 0,
    [SPECIES_WHERML] = 0,
    [SPECIES_CRUSTERROR] = 2,
    [SPECIES_MANTACORE] = 3,
    [SPECIES_SKULDUGERY] = 0,
    [SPECIES_GRAVENDOR] = 2,
    [SPECIES_OGWON_ROCK] = 1,
    [SPECIES_GRUBBLE] = 0,
    [SPECIES_GRACKLIN] = 2,
    [SPECIES_SHAMBURGER] = 5,
    [SPECIES_FROZHORN] = 0,
    [SPECIES_FROZFORCE] = 3,
    [SPECIES_STAALNARY] = 0,
    [SPECIES_BAROMITE] = 0,
    ...
    [SPECIES_MALMARE] = 2,
    [SPECIES_SWEETAN] = 0,
    [SPECIES_MELCERALBA] = 5,
    [SPECIES_BUGGORY] = 5,
    [SPECIES_ZAPPUG] = 0,
    [SPECIES_PUPULZE] = 0,
    [SPECIES_RUBIMIZER] = 0,
    [SPECIES_RICKSHAWTY] = 4,
    [SPECIES_TREMITE] = 0,
    [SPECIES_TROHIVE] = 0,
    [SPECIES_CASTERMITE] = 0,
    [SPECIES_EYESLIGHT] = 0,
    [SPECIES_BEHOLZER] = 0,
    [SPECIES_EYERISH] = 0,
    [SPECIES_RETINEEL] = 0,
    [SPECIES_ASTIGMORAY] = 3,
    [SPECIES_GELECTUAL] = 2,
    [SPECIES_REBRR] = 0,
    [SPECIES_FERROFROS] = 0,
    [SPECIES_FORTIFROS] = 0,
    ...
    [SPECIES_HAGOOSH_VISCOUS] = 5,
    [SPECIES_ASTIGMORAY_BLIND] = 3,
    [SPECIES_RICKSHAWTY_CHARIOT] = 4,
    [SPECIES_MALMARE_VIRUS] = 1,
#endif
    [SPECIES_EGG] = 1,
};
