...
static const u8 sText_PkmnsFeltPressureFromItsStatBuffs[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY} damaged it\nfrom its stat buffs!");
...
static const u8 sText_PkmnsXTauntedY[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\ntaunted {B_ATK_NAME_WITH_PREFIX}!");
...
static const u8 sText_SpaceCrookDmg[] = _("{B_DEF_NAME_WITH_PREFIX} feels the madness!");
...
static const u8 sText_PkmnPlayedASpade[] = _("{B_ATK_NAME_WITH_PREFIX} played a spade!");
static const u8 sText_PkmnPlayedAHeart[] = _("{B_ATK_NAME_WITH_PREFIX} played a heart!");
static const u8 sText_PkmnPlayedAClub[] = _("{B_ATK_NAME_WITH_PREFIX} played a club!");
static const u8 sText_PkmnPlayedADiamond[] = _("{B_ATK_NAME_WITH_PREFIX} played a diamond!");
...
static const u8 sText_SungAHealingMelody[] = _("{B_ATK_NAME_WITH_PREFIX} sung\na healing melody!");
static const u8 sText_HealingMelodyWasHeard[] = _("{B_ATK_NAME_WITH_PREFIX} heard\na healing melody!");
static const u8 sText_TargetInFlames[] = _("The {B_DEF_NAME_WITH_PREFIX}'s moves\nhave been put ablaze!");
...
static const u8 sText_BecomingDirtyAngeredIt[] = _("Becoming dirty by {B_CURRENT_MOVE}\nangered {B_DEF_NAME_WITH_PREFIX}!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_SUNGAHEALINGMELODY - BATTLESTRINGS_TABLE_START] = sText_SungAHealingMelody,
    [STRINGID_HEALINGMELODYWASHEARD - BATTLESTRINGS_TABLE_START] = sText_HealingMelodyWasHeard,
    [STRINGID_TARGETINFLAMES - BATTLESTRINGS_TABLE_START] = sText_TargetInFlames,
    ...
    [STRINGID_SPACECROOKDMG - BATTLESTRINGS_TABLE_START] = sText_SpaceCrookDmg,
    [STRINGID_PKMNSXDAMAGEDITALITTLE - BATTLESTRINGS_TABLE_START] = sText_PkmnsXDamagedItALittle,
    [STRINGID_SUNK_COST - BATTLESTRINGS_TABLE_START] = sText_SunkCost,
    [STRINGID_BECOMINGDIRTYANGEREDIT - BATTLESTRINGS_TABLE_START] = sText_BecomingDirtyAngeredIt,
    [STRINGID_PKMNPLAYEDASPADE - BATTLESTRINGS_TABLE_START] = sText_PkmnPlayedASpade,
    [STRINGID_PKMNPLAYEDAHEART - BATTLESTRINGS_TABLE_START] = sText_PkmnPlayedAHeart,
    ...
    [STRINGID_PKMNFELTPRESSUREFROMITSSTATBUFFS - BATTLESTRINGS_TABLE_START] = sText_PkmnsFeltPressureFromItsStatBuffs,
};
