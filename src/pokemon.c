...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(GOOPER),
    SPECIES_TO_HOENN(SWISQUIRE),
    SPECIES_TO_HOENN(MOG),
    SPECIES_TO_HOENN(PROFUR),
    SPECIES_TO_HOENN(MUNNA),
    SPECIES_TO_HOENN(MUSHARNA),
    SPECIES_TO_HOENN(PARAS),
    SPECIES_TO_HOENN(PARASECT),
    SPECIES_TO_HOENN(CELSHRIOOM),
    SPECIES_TO_HOENN(DADALEMMA),
    SPECIES_TO_HOENN(TEDDIURSA),
    SPECIES_TO_HOENN(URSARING),
    SPECIES_TO_HOENN(CRAWTENDR),
    SPECIES_TO_HOENN(OKKAMIRIZO),
    SPECIES_TO_HOENN(PLANTATORI),
    SPECIES_TO_HOENN(SAPPOD),
    SPECIES_TO_HOENN(SHELBERT),
    SPECIES_TO_HOENN(SHELEBRATE),
    SPECIES_TO_HOENN(SNORT_ALPACA),
    SPECIES_TO_HOENN(PLAINTAIN),
    SPECIES_TO_HOENN(MUSALORD),
    SPECIES_TO_HOENN(BREVATO),
    SPECIES_TO_HOENN(KELPPY),
    SPECIES_TO_HOENN(LURKELP),
    SPECIES_TO_HOENN(SHROOMOINK),
    SPECIES_TO_HOENN(SPORKE),
    SPECIES_TO_HOENN(CHERNOBOAR),
    SPECIES_TO_HOENN(GULPIN),
    SPECIES_TO_HOENN(SWALOT),
    SPECIES_TO_HOENN(CACNEA),
    SPECIES_TO_HOENN(CACTURNE),
    SPECIES_TO_HOENN(BURSTAD),
    SPECIES_TO_HOENN(BLASTOAD),
    SPECIES_TO_HOENN(EXPLOAD),
    SPECIES_TO_HOENN(ICANDESFEN),
    SPECIES_TO_HOENN(ARON),
    SPECIES_TO_HOENN(LAIRON),
    SPECIES_TO_HOENN(AGGRON),
    SPECIES_TO_HOENN(MAGIDASH),
    SPECIES_TO_HOENN(SERAPHURE),
    ...
    SPECIES_TO_HOENN(HAGOOSH),
    SPECIES_TO_HOENN(PYUKUMUKU),
    SPECIES_TO_HOENN(WAKASUKA),
    SPECIES_TO_HOENN(DULLSOD),
    SPECIES_TO_HOENN(BEVOLPIN),
    SPECIES_TO_HOENN(WATTL),
    SPECIES_TO_HOENN(XOLHM),
    SPECIES_TO_HOENN(TYNAMO),
    SPECIES_TO_HOENN(EELEKTRIK),
    SPECIES_TO_HOENN(EELEKTROSS),
    SPECIES_TO_HOENN(ODDIOWAVE),
    SPECIES_TO_HOENN(WHERML),
    SPECIES_TO_HOENN(CRUSTERROR),
    SPECIES_TO_HOENN(MANTACORE),
    SPECIES_TO_HOENN(SKULDUGERY),
    SPECIES_TO_HOENN(GRAVENDOR),
    SPECIES_TO_HOENN(OGWON_ROCK),
    SPECIES_TO_HOENN(GRUBBLE),
    SPECIES_TO_HOENN(GRACKLIN),
    SPECIES_TO_HOENN(SHAMBURGER),
    SPECIES_TO_HOENN(FROZHORN),
    SPECIES_TO_HOENN(FROZFORCE),
    SPECIES_TO_HOENN(STAALNARY),
    SPECIES_TO_HOENN(PORYGON),
    SPECIES_TO_HOENN(PORYGON2),
    SPECIES_TO_HOENN(BAROMITE),
    SPECIES_TO_HOENN(NAPALMITE),
    SPECIES_TO_HOENN(STOVLARE),
    SPECIES_TO_HOENN(ORBACLE),
    SPECIES_TO_HOENN(NINOWN),
    ...
    SPECIES_TO_HOENN(CARDICT),
    SPECIES_TO_HOENN(POKERLORD),
    SPECIES_TO_HOENN(DEGOURGE),
    SPECIES_TO_HOENN(TUETUERROR),
    SPECIES_TO_HOENN(BAGHOST),
    SPECIES_TO_HOENN(BAGHOUL),
    ...
    SPECIES_TO_HOENN(WUVME),
    SPECIES_TO_HOENN(EKANS),
    SPECIES_TO_HOENN(ARBOK),
    SPECIES_TO_HOENN(VEEBLEN),
    SPECIES_TO_HOENN(MALACHREY),
    SPECIES_TO_HOENN(MALMARE),
    SPECIES_TO_HOENN(SWEETAN),
    SPECIES_TO_HOENN(MELCERALBA),
    SPECIES_TO_HOENN(BUGGORY),
    SPECIES_TO_HOENN(ZAPPUG),
    SPECIES_TO_HOENN(PUPULZE),
    SPECIES_TO_HOENN(RUBIMIZER),
    SPECIES_TO_HOENN(RICKSHAWTY),
    SPECIES_TO_HOENN(TREMITE),
    SPECIES_TO_HOENN(TROHIVE),
    SPECIES_TO_HOENN(CASTERMITE),
    SPECIES_TO_HOENN(SEEL),
    SPECIES_TO_HOENN(DEWGONG),
    SPECIES_TO_HOENN(VOLCARONA),
    SPECIES_TO_HOENN(EYESLIGHT),
    SPECIES_TO_HOENN(BEHOLZER),
    SPECIES_TO_HOENN(REGIDRAGO),
    SPECIES_TO_HOENN(EYERISH),
    SPECIES_TO_HOENN(RETINEEL),
    SPECIES_TO_HOENN(ASTIGMORAY),
    SPECIES_TO_HOENN(CHARIZARD),
    SPECIES_TO_HOENN(GELECTUAL),
    SPECIES_TO_HOENN(REBRR),
    SPECIES_TO_HOENN(FERROFROS),
    SPECIES_TO_HOENN(FORTIFROS),
    SPECIES_TO_HOENN(ARCTIKACK),
    SPECIES_TO_HOENN(CORSOLA),
    SPECIES_TO_HOENN(CURSOLA),
    SPECIES_TO_HOENN(PRISMAPUP),
    SPECIES_TO_HOENN(VIVIDAWG),
    SPECIES_TO_HOENN(KITTEPUP),
    SPECIES_TO_HOENN(PECKACHEW),
    SPECIES_TO_HOENN(SKOOKY),
    SPECIES_TO_HOENN(VIZAAVISO),
    SPECIES_TO_HOENN(SETATONKRE),
    SPECIES_TO_HOENN(PANZEEHEE),
    SPECIES_TO_HOENN(BABOBO),
    SPECIES_TO_HOENN(GROOSE),
    SPECIES_TO_HOENN(GREESE),
    SPECIES_TO_HOENN(DIGLETT),
    SPECIES_TO_HOENN(DUGTRIO),

    [SPECIES_HAGOOSH_VISCOUS - 1] = HOENN_DEX_HAGOOSH,
    [SPECIES_ASTIGMORAY_BLIND - 1] = HOENN_DEX_ASTIGMORAY,
    [SPECIES_RICKSHAWTY_CHARIOT - 1] = HOENN_DEX_RICKSHAWTY,
    [SPECIES_MALMARE_VIRUS - 1] = HOENN_DEX_MALMARE,
};
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(GOOPER),
    SPECIES_TO_NATIONAL(SWISQUIRE),
    SPECIES_TO_NATIONAL(MOG),
    SPECIES_TO_NATIONAL(PROFUR),
    SPECIES_TO_NATIONAL(CELSHRIOOM),
    SPECIES_TO_NATIONAL(DADALEMMA),
    SPECIES_TO_NATIONAL(CRAWTENDR),
    SPECIES_TO_NATIONAL(OKKAMIRIZO),
    SPECIES_TO_NATIONAL(PLANTATORI),
    SPECIES_TO_NATIONAL(SAPPOD),
    SPECIES_TO_NATIONAL(SHELBERT),
    SPECIES_TO_NATIONAL(SHELEBRATE),
    SPECIES_TO_NATIONAL(SNORT_ALPACA),
    SPECIES_TO_NATIONAL(PLAINTAIN),
    SPECIES_TO_NATIONAL(MUSALORD),
    SPECIES_TO_NATIONAL(BREVATO),
    SPECIES_TO_NATIONAL(KELPPY),
    SPECIES_TO_NATIONAL(LURKELP),
    SPECIES_TO_NATIONAL(SHROOMOINK),
    SPECIES_TO_NATIONAL(SPORKE),
    SPECIES_TO_NATIONAL(CHERNOBOAR),
    SPECIES_TO_NATIONAL(BURSTAD),
    SPECIES_TO_NATIONAL(BLASTOAD),
    SPECIES_TO_NATIONAL(EXPLOAD),
    SPECIES_TO_NATIONAL(ICANDESFEN),
    SPECIES_TO_NATIONAL(MAGIDASH),
    SPECIES_TO_NATIONAL(SERAPHURE),
    SPECIES_TO_NATIONAL(HAGOOSH),
    SPECIES_TO_NATIONAL(WAKASUKA),
    SPECIES_TO_NATIONAL(DULLSOD),
    SPECIES_TO_NATIONAL(BEVOLPIN),
    SPECIES_TO_NATIONAL(WATTL),
    SPECIES_TO_NATIONAL(XOLHM),
    SPECIES_TO_NATIONAL(ODDIOWAVE),
    SPECIES_TO_NATIONAL(WHERML),
    SPECIES_TO_NATIONAL(CRUSTERROR),
    SPECIES_TO_NATIONAL(MANTACORE),
    SPECIES_TO_NATIONAL(SKULDUGERY),
    SPECIES_TO_NATIONAL(GRAVENDOR),
    SPECIES_TO_NATIONAL(OGWON_ROCK),
    SPECIES_TO_NATIONAL(GRUBBLE),
    SPECIES_TO_NATIONAL(GRACKLIN),
    SPECIES_TO_NATIONAL(SHAMBURGER),
    SPECIES_TO_NATIONAL(FROZHORN),
    SPECIES_TO_NATIONAL(FROZFORCE),
    SPECIES_TO_NATIONAL(STAALNARY),
    SPECIES_TO_NATIONAL(BAROMITE),
    SPECIES_TO_NATIONAL(NAPALMITE),
    SPECIES_TO_NATIONAL(STOVLARE),
    SPECIES_TO_NATIONAL(ORBACLE),
    SPECIES_TO_NATIONAL(NINOWN),
    SPECIES_TO_NATIONAL(CARDICT),
    SPECIES_TO_NATIONAL(POKERLORD),
    SPECIES_TO_NATIONAL(DEGOURGE),
    SPECIES_TO_NATIONAL(TUETUERROR),
    SPECIES_TO_NATIONAL(BAGHOST),
    SPECIES_TO_NATIONAL(BAGHOUL),
    SPECIES_TO_NATIONAL(WUVME),
    SPECIES_TO_NATIONAL(VEEBLEN),
    SPECIES_TO_NATIONAL(MALACHREY),
    SPECIES_TO_NATIONAL(MALMARE),
    SPECIES_TO_NATIONAL(SWEETAN),
    SPECIES_TO_NATIONAL(MELCERALBA),
    SPECIES_TO_NATIONAL(BUGGORY),
    SPECIES_TO_NATIONAL(ZAPPUG),
    SPECIES_TO_NATIONAL(PUPULZE),
    SPECIES_TO_NATIONAL(RUBIMIZER),
    SPECIES_TO_NATIONAL(RICKSHAWTY),
    SPECIES_TO_NATIONAL(TREMITE),
    SPECIES_TO_NATIONAL(TROHIVE),
    SPECIES_TO_NATIONAL(CASTERMITE),
    SPECIES_TO_NATIONAL(EYESLIGHT),
    SPECIES_TO_NATIONAL(BEHOLZER),
    SPECIES_TO_NATIONAL(EYERISH),
    SPECIES_TO_NATIONAL(RETINEEL),
    SPECIES_TO_NATIONAL(ASTIGMORAY),
    SPECIES_TO_NATIONAL(GELECTUAL),
    SPECIES_TO_NATIONAL(REBRR),
    SPECIES_TO_NATIONAL(FERROFROS),
    SPECIES_TO_NATIONAL(FORTIFROS),
    SPECIES_TO_NATIONAL(ARCTIKACK),
    SPECIES_TO_NATIONAL(PRISMAPUP),
    SPECIES_TO_NATIONAL(VIVIDAWG),
    SPECIES_TO_NATIONAL(KITTEPUP),
    SPECIES_TO_NATIONAL(PECKACHEW),
    SPECIES_TO_NATIONAL(SKOOKY),
    SPECIES_TO_NATIONAL(VIZAAVISO),
    SPECIES_TO_NATIONAL(SETATONKRE),
    SPECIES_TO_NATIONAL(PANZEEHEE),
    SPECIES_TO_NATIONAL(BABOBO),
    SPECIES_TO_NATIONAL(GROOSE),
    SPECIES_TO_NATIONAL(GREESE),
#endif
...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(GOOPER),
    HOENN_TO_NATIONAL(SWISQUIRE),
    HOENN_TO_NATIONAL(MOG),
    HOENN_TO_NATIONAL(PROFUR),
    HOENN_TO_NATIONAL(MUNNA),
    HOENN_TO_NATIONAL(MUSHARNA),
    HOENN_TO_NATIONAL(PARAS),
    HOENN_TO_NATIONAL(PARASECT),
    HOENN_TO_NATIONAL(CELSHRIOOM),
    HOENN_TO_NATIONAL(DADALEMMA),
    HOENN_TO_NATIONAL(TEDDIURSA),
    HOENN_TO_NATIONAL(URSARING),
    HOENN_TO_NATIONAL(CRAWTENDR),
    HOENN_TO_NATIONAL(OKKAMIRIZO),
    HOENN_TO_NATIONAL(PLANTATORI),
    HOENN_TO_NATIONAL(SAPPOD),
    HOENN_TO_NATIONAL(SHELBERT),
    HOENN_TO_NATIONAL(SHELEBRATE),
    HOENN_TO_NATIONAL(SNORT_ALPACA),
    HOENN_TO_NATIONAL(PLAINTAIN),
    HOENN_TO_NATIONAL(MUSALORD),
    HOENN_TO_NATIONAL(BREVATO),
    HOENN_TO_NATIONAL(KELPPY),
    HOENN_TO_NATIONAL(LURKELP),
    HOENN_TO_NATIONAL(SHROOMOINK),
    HOENN_TO_NATIONAL(SPORKE),
    HOENN_TO_NATIONAL(CHERNOBOAR),
    HOENN_TO_NATIONAL(GULPIN),
    HOENN_TO_NATIONAL(SWALOT),
    HOENN_TO_NATIONAL(CACNEA),
    HOENN_TO_NATIONAL(CACTURNE),
    HOENN_TO_NATIONAL(BURSTAD),
    HOENN_TO_NATIONAL(BLASTOAD),
    HOENN_TO_NATIONAL(EXPLOAD),
    HOENN_TO_NATIONAL(ICANDESFEN),
    HOENN_TO_NATIONAL(ARON),
    HOENN_TO_NATIONAL(LAIRON),
    HOENN_TO_NATIONAL(AGGRON),
    HOENN_TO_NATIONAL(MAGIDASH),
    HOENN_TO_NATIONAL(SERAPHURE),
    ...
    HOENN_TO_NATIONAL(HAGOOSH),
    HOENN_TO_NATIONAL(PYUKUMUKU),
    HOENN_TO_NATIONAL(WAKASUKA),
    HOENN_TO_NATIONAL(DULLSOD),
    HOENN_TO_NATIONAL(BEVOLPIN),
    HOENN_TO_NATIONAL(WATTL),
    HOENN_TO_NATIONAL(XOLHM),
    HOENN_TO_NATIONAL(TYNAMO),
    HOENN_TO_NATIONAL(EELEKTRIK),
    HOENN_TO_NATIONAL(EELEKTROSS),
    HOENN_TO_NATIONAL(ODDIOWAVE),
    HOENN_TO_NATIONAL(WHERML),
    HOENN_TO_NATIONAL(CRUSTERROR),
    HOENN_TO_NATIONAL(MANTACORE),
    HOENN_TO_NATIONAL(SKULDUGERY),
    HOENN_TO_NATIONAL(GRAVENDOR),
    HOENN_TO_NATIONAL(OGWON_ROCK),
    HOENN_TO_NATIONAL(GRUBBLE),
    HOENN_TO_NATIONAL(GRACKLIN),
    HOENN_TO_NATIONAL(SHAMBURGER),
    HOENN_TO_NATIONAL(FROZHORN),
    HOENN_TO_NATIONAL(FROZFORCE),
    HOENN_TO_NATIONAL(STAALNARY),
    HOENN_TO_NATIONAL(PORYGON),
    HOENN_TO_NATIONAL(PORYGON2),
    HOENN_TO_NATIONAL(BAROMITE),
    HOENN_TO_NATIONAL(NAPALMITE),
    HOENN_TO_NATIONAL(STOVLARE),
    HOENN_TO_NATIONAL(ORBACLE),
    HOENN_TO_NATIONAL(NINOWN),
    ...
    HOENN_TO_NATIONAL(CARDICT),
    HOENN_TO_NATIONAL(POKERLORD),
    HOENN_TO_NATIONAL(DEGOURGE),
    HOENN_TO_NATIONAL(TUETUERROR),
    HOENN_TO_NATIONAL(BAGHOST),
    HOENN_TO_NATIONAL(BAGHOUL),
    ...
    HOENN_TO_NATIONAL(WUVME),
    HOENN_TO_NATIONAL(EKANS),
    HOENN_TO_NATIONAL(ARBOK),
    HOENN_TO_NATIONAL(VEEBLEN),
    HOENN_TO_NATIONAL(MALACHREY),
    HOENN_TO_NATIONAL(MALMARE),
    HOENN_TO_NATIONAL(SWEETAN),
    HOENN_TO_NATIONAL(MELCERALBA),
    HOENN_TO_NATIONAL(BUGGORY),
    HOENN_TO_NATIONAL(ZAPPUG),
    HOENN_TO_NATIONAL(PUPULZE),
    HOENN_TO_NATIONAL(RUBIMIZER),
    HOENN_TO_NATIONAL(RICKSHAWTY),
    HOENN_TO_NATIONAL(TREMITE),
    HOENN_TO_NATIONAL(TROHIVE),
    HOENN_TO_NATIONAL(CASTERMITE),
    HOENN_TO_NATIONAL(SEEL),
    HOENN_TO_NATIONAL(DEWGONG),
    HOENN_TO_NATIONAL(VOLCARONA),
    HOENN_TO_NATIONAL(EYESLIGHT),
    HOENN_TO_NATIONAL(BEHOLZER),
    HOENN_TO_NATIONAL(REGIDRAGO),
    HOENN_TO_NATIONAL(EYERISH),
    HOENN_TO_NATIONAL(RETINEEL),
    HOENN_TO_NATIONAL(ASTIGMORAY),
    HOENN_TO_NATIONAL(CHARIZARD),
    HOENN_TO_NATIONAL(GELECTUAL),
    HOENN_TO_NATIONAL(REBRR),
    HOENN_TO_NATIONAL(FERROFROS),
    HOENN_TO_NATIONAL(FORTIFROS),
    HOENN_TO_NATIONAL(ARCTIKACK),
    HOENN_TO_NATIONAL(CORSOLA),
    HOENN_TO_NATIONAL(CURSOLA),
    HOENN_TO_NATIONAL(PRISMAPUP),
    HOENN_TO_NATIONAL(VIVIDAWG),
    HOENN_TO_NATIONAL(KITTEPUP),
    HOENN_TO_NATIONAL(PECKACHEW),
    HOENN_TO_NATIONAL(SKOOKY),
    HOENN_TO_NATIONAL(VIZAAVISO),
    HOENN_TO_NATIONAL(SETATONKRE),
    HOENN_TO_NATIONAL(PANZEEHEE),
    HOENN_TO_NATIONAL(BABOBO),
    HOENN_TO_NATIONAL(GROOSE),
    HOENN_TO_NATIONAL(GREESE),
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_GOOPER - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SWISQUIRE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MOG - 1]            = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PROFUR - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CELSHRIOOM - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DADALEMMA - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CRAWTENDR - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_OKKAMIRIZO - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PLANTATORI - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SAPPOD - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SHELBERT - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SHELEBRATE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SNORT_ALPACA - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PLAINTAIN - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MUSALORD - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BREVATO - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KELPPY - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LURKELP - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SHROOMOINK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SPORKE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CHERNOBOAR - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BURSTAD - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BLASTOAD - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_EXPLOAD - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FBI_PENGUIN_1 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FBI_PENGUIN_2 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ICANDESFEN - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MAGIDASH - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SERAPHURE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HAGOOSH - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WAKASUKA - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DULLSOD - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BEVOLPIN - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WATTL - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_XOLHM - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ODDIOWAVE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WHERML - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CRUSTERROR - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MANTACORE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SKULDUGERY - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GRAVENDOR - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_OGWON_ROCK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GRUBBLE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GRACKLIN - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SHAMBURGER - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FROZHORN - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FROZFORCE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_STAALNARY - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BAROMITE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NAPALMITE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_STOVLARE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ORBACLE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NINOWN - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CARDICT - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_POKERLORD - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DEGOURGE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TUETUERROR - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BAGHOST - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BAGHOUL - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WUVME - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_VEEBLEN - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MALACHREY - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MALMARE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SWEETAN - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MELCERALBA - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BUGGORY - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ZAPPUG - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PUPULZE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RUBIMIZER - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RICKSHAWTY - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TREMITE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TROHIVE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CASTERMITE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_EYESLIGHT - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BEHOLZER - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_EYERISH - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RETINEEL - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ASTIGMORAY - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GELECTUAL - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_REBRR - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FERROFROS - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FORTIFROS - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ARCTIKACK - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PRISMAPUP - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_VIVIDAWG - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KITTEPUP - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PECKACHEW - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SKOOKY - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_VIZAAVISO - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SETATONKRE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PANZEEHEE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BABOBO - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GROOSE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GREESE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
