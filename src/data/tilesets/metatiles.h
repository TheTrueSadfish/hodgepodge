...
const u16 gMetatiles_Meat[] = INCBIN_U16("data/tilesets/secondary/meat/metatiles.bin");
const u16 gMetatileAttributes_Meat[] = INCBIN_U16("data/tilesets/secondary/meat/metatile_attributes.bin");
