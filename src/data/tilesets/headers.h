...
const struct Tileset gTileset_Meat =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Meat,
    .palettes = gTilesetPalettes_Meat,
    .metatiles = gMetatiles_Meat,
    .metatileAttributes = gMetatileAttributes_Meat,
    .callback = NULL,
};
