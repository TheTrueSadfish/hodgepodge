const struct CompressedSpritePalette gMonShinyPaletteTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SHINY_PAL(GOOPER, gMonShinyPalette_Gooper),
    SPECIES_SHINY_PAL(SWISQUIRE, gMonShinyPalette_Swisquire),
    SPECIES_SHINY_PAL(MOG, gMonShinyPalette_Mog),
    SPECIES_SHINY_PAL(PROFUR, gMonShinyPalette_Profur),
    SPECIES_SHINY_PAL(CELSHRIOOM, gMonShinyPalette_Celshrioom),
    SPECIES_SHINY_PAL(DADALEMMA, gMonShinyPalette_Dadalemma),
    SPECIES_SHINY_PAL(CRAWTENDR, gMonShinyPalette_Crawtendr),
    SPECIES_SHINY_PAL(OKKAMIRIZO, gMonShinyPalette_Okkamirizo),
    SPECIES_SHINY_PAL(PLANTATORI, gMonShinyPalette_Plantatori),
    SPECIES_SHINY_PAL(SAPPOD, gMonShinyPalette_Sappod),
    SPECIES_SHINY_PAL(SHELBERT, gMonShinyPalette_Shelbert),
    SPECIES_SHINY_PAL(SHELEBRATE, gMonShinyPalette_Shelebrate),
    SPECIES_SHINY_PAL(SNORT_ALPACA, gMonShinyPalette_SnortAlpaca),
    SPECIES_SHINY_PAL(PLAINTAIN, gMonShinyPalette_Plaintain),
    SPECIES_SHINY_PAL(MUSALORD, gMonShinyPalette_Musalord),
    SPECIES_SHINY_PAL(BREVATO, gMonShinyPalette_Brevato),
    SPECIES_SHINY_PAL(KELPPY, gMonShinyPalette_Kelppy),
    SPECIES_SHINY_PAL(LURKELP, gMonShinyPalette_Lurkelp),
    SPECIES_SHINY_PAL(SHROOMOINK, gMonShinyPalette_Shroomoink),
    SPECIES_SHINY_PAL(SPORKE, gMonShinyPalette_Sporke),
    SPECIES_SHINY_PAL(CHERNOBOAR, gMonShinyPalette_Chernoboar),
    SPECIES_SHINY_PAL(BURSTAD, gMonShinyPalette_Burstad),
    SPECIES_SHINY_PAL(BLASTOAD, gMonShinyPalette_Blastoad),
    SPECIES_SHINY_PAL(EXPLOAD, gMonShinyPalette_Expload),
    SPECIES_SHINY_PAL(FBI_PENGUIN_1, gMonShinyPalette_FBIPenguin1),
    SPECIES_SHINY_PAL(FBI_PENGUIN_2, gMonShinyPalette_FBIPenguin2),
    SPECIES_SHINY_PAL(ICANDESFEN, gMonShinyPalette_Icandesfen),
    SPECIES_SHINY_PAL(MAGIDASH, gMonShinyPalette_Magidash),
    SPECIES_SHINY_PAL(SERAPHURE, gMonShinyPalette_Seraphure),
    SPECIES_SHINY_PAL(HAGOOSH, gMonShinyPalette_Hagoosh),
    SPECIES_SHINY_PAL(HAGOOSH_VISCOUS, gMonShinyPalette_HagooshViscous),
    SPECIES_SHINY_PAL(WAKASUKA, gMonShinyPalette_Wakasuka),
    SPECIES_SHINY_PAL(DULLSOD, gMonShinyPalette_Dullsod),
    SPECIES_SHINY_PAL(BEVOLPIN, gMonShinyPalette_Bevolpin),
    SPECIES_SHINY_PAL(WATTL, gMonShinyPalette_Wattl),
    SPECIES_SHINY_PAL(XOLHM, gMonShinyPalette_Xolhm),
    SPECIES_SHINY_PAL(ODDIOWAVE, gMonShinyPalette_Oddiowave),
    SPECIES_SHINY_PAL(WHERML, gMonShinyPalette_Wherml),
    SPECIES_SHINY_PAL(CRUSTERROR, gMonShinyPalette_Crusterror),
    SPECIES_SHINY_PAL(MANTACORE, gMonShinyPalette_Mantacore),
    SPECIES_SHINY_PAL(SKULDUGERY, gMonShinyPalette_Skuldugery),
    SPECIES_SHINY_PAL(GRAVENDOR, gMonShinyPalette_Gravendor),
    SPECIES_SHINY_PAL(OGWON_ROCK, gMonShinyPalette_OgwonRock),
    SPECIES_SHINY_PAL(GRUBBLE, gMonShinyPalette_Grubble),
    SPECIES_SHINY_PAL(GRACKLIN, gMonShinyPalette_Gracklin),
    SPECIES_SHINY_PAL(SHAMBURGER, gMonShinyPalette_Shamburger),
    SPECIES_SHINY_PAL(FROZHORN, gMonShinyPalette_Frozhorn),
    SPECIES_SHINY_PAL(FROZFORCE, gMonShinyPalette_Frozforce),
    SPECIES_SHINY_PAL(STAALNARY, gMonShinyPalette_Staalnary),
    SPECIES_SHINY_PAL(BAROMITE, gMonShinyPalette_Baromite),
    SPECIES_SHINY_PAL(NAPALMITE, gMonShinyPalette_Napalmite),
    SPECIES_SHINY_PAL(STOVLARE, gMonShinyPalette_Stovlare),
    SPECIES_SHINY_PAL(ORBACLE, gMonShinyPalette_Orbacle),
    SPECIES_SHINY_PAL(NINOWN, gMonShinyPalette_Ninown),
    SPECIES_SHINY_PAL(CARDICT, gMonShinyPalette_Cardict),
    SPECIES_SHINY_PAL(POKERLORD, gMonShinyPalette_Pokerlord),
    SPECIES_SHINY_PAL(DEGOURGE, gMonShinyPalette_Degourge),
    SPECIES_SHINY_PAL(TUETUERROR, gMonShinyPalette_Tuetuerror),
    SPECIES_SHINY_PAL(BAGHOST, gMonShinyPalette_Baghost),
    SPECIES_SHINY_PAL(BAGHOUL, gMonShinyPalette_Baghoul),
    SPECIES_SHINY_PAL(WUVME, gMonShinyPalette_Wuvme),
    SPECIES_SHINY_PAL(VEEBLEN, gMonShinyPalette_Veeblen),
    SPECIES_SHINY_PAL(MALACHREY, gMonShinyPalette_Malachrey),
    SPECIES_SHINY_PAL(MALMARE, gMonShinyPalette_Malmare),
    SPECIES_SHINY_PAL(MALMARE_VIRUS, gMonShinyPalette_MalmareVirus),
    SPECIES_SHINY_PAL(SWEETAN, gMonShinyPalette_Sweetan),
    SPECIES_SHINY_PAL(MELCERALBA, gMonShinyPalette_Melceralba),
    SPECIES_SHINY_PAL(BUGGORY, gMonShinyPalette_Buggory),
    SPECIES_SHINY_PAL(ZAPPUG, gMonShinyPalette_Zappug),
    SPECIES_SHINY_PAL(PUPULZE, gMonShinyPalette_Pupulze),
    SPECIES_SHINY_PAL(RUBIMIZER, gMonShinyPalette_Rubimizer),
    SPECIES_SHINY_PAL(RICKSHAWTY, gMonShinyPalette_Rickshawty),
    SPECIES_SHINY_PAL(RICKSHAWTY_CHARIOT, gMonShinyPalette_RickshawtyChariot),
    SPECIES_SHINY_PAL(TREMITE, gMonShinyPalette_Tremite),
    SPECIES_SHINY_PAL(TROHIVE, gMonShinyPalette_Trohive),
    SPECIES_SHINY_PAL(CASTERMITE, gMonShinyPalette_Castermite),
    SPECIES_SHINY_PAL(EYESLIGHT, gMonShinyPalette_Eyeslight),
    SPECIES_SHINY_PAL(BEHOLZER, gMonShinyPalette_Beholzer),
    SPECIES_SHINY_PAL(EYERISH, gMonShinyPalette_Eyerish),
    SPECIES_SHINY_PAL(RETINEEL, gMonShinyPalette_Retineel),
    SPECIES_SHINY_PAL(ASTIGMORAY, gMonShinyPalette_Astigmoray),
    SPECIES_SHINY_PAL(ASTIGMORAY_BLIND, gMonShinyPalette_AstigmorayBlind),
    SPECIES_SHINY_PAL(GELECTUAL, gMonShinyPalette_Gelectual),
    SPECIES_SHINY_PAL(REBRR, gMonShinyPalette_Rebrr),
    SPECIES_SHINY_PAL(FERROFROS, gMonShinyPalette_Ferrofros),
    SPECIES_SHINY_PAL(FORTIFROS, gMonShinyPalette_Fortifros),
    SPECIES_SHINY_PAL(ARCTIKACK, gMonShinyPalette_Arctikack),
    SPECIES_SHINY_PAL(PRISMAPUP, gMonShinyPalette_Prismapup),
    SPECIES_SHINY_PAL(VIVIDAWG, gMonShinyPalette_Vividawg),
    SPECIES_SHINY_PAL(KITTEPUP, gMonShinyPalette_Kittepup),
    SPECIES_SHINY_PAL(PECKACHEW, gMonShinyPalette_Peckachew),
    SPECIES_SHINY_PAL(SKOOKY, gMonShinyPalette_Skooky),
    SPECIES_SHINY_PAL(VIZAAVISO, gMonShinyPalette_Vizaaviso),
    SPECIES_SHINY_PAL(SETATONKRE, gMonShinyPalette_Setatonkre),
    SPECIES_SHINY_PAL(PANZEEHEE, gMonShinyPalette_Panzeehee),
    SPECIES_SHINY_PAL(BABOBO, gMonShinyPalette_Babobo),
    SPECIES_SHINY_PAL(GROOSE, gMonShinyPalette_Groose),
    SPECIES_SHINY_PAL(GREESE, gMonShinyPalette_Greese),
#endif
