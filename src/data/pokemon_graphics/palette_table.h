const struct CompressedSpritePalette gMonPaletteTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_PAL(GOOPER, gMonPalette_Gooper),
    SPECIES_PAL(SWISQUIRE, gMonPalette_Swisquire),
    SPECIES_PAL(MOG, gMonPalette_Mog),
    SPECIES_PAL(PROFUR, gMonPalette_Profur),
    SPECIES_PAL(CELSHRIOOM, gMonPalette_Celshrioom),
    SPECIES_PAL(DADALEMMA, gMonPalette_Dadalemma),
    SPECIES_PAL(CRAWTENDR, gMonPalette_Crawtendr),
    SPECIES_PAL(OKKAMIRIZO, gMonPalette_Okkamirizo),
    SPECIES_PAL(PLANTATORI, gMonPalette_Plantatori),
    SPECIES_PAL(SAPPOD, gMonPalette_Sappod),
    SPECIES_PAL(SHELBERT, gMonPalette_Shelbert),
    SPECIES_PAL(SHELEBRATE, gMonPalette_Shelebrate),
    SPECIES_PAL(SNORT_ALPACA, gMonPalette_SnortAlpaca),
    SPECIES_PAL(PLAINTAIN, gMonPalette_Plaintain),
    SPECIES_PAL(MUSALORD, gMonPalette_Musalord),
    SPECIES_PAL(BREVATO, gMonPalette_Brevato),
    SPECIES_PAL(KELPPY, gMonPalette_Kelppy),
    SPECIES_PAL(LURKELP, gMonPalette_Lurkelp),
    SPECIES_PAL(SHROOMOINK, gMonPalette_Shroomoink),
    SPECIES_PAL(SPORKE, gMonPalette_Sporke),
    SPECIES_PAL(CHERNOBOAR, gMonPalette_Chernoboar),
    SPECIES_PAL(BURSTAD, gMonPalette_Burstad),
    SPECIES_PAL(BLASTOAD, gMonPalette_Blastoad),
    SPECIES_PAL(EXPLOAD, gMonPalette_Expload),
    SPECIES_PAL(FBI_PENGUIN_1, gMonPalette_FBIPenguin1),
    SPECIES_PAL(FBI_PENGUIN_2, gMonPalette_FBIPenguin2),
    SPECIES_PAL(ICANDESFEN, gMonPalette_Icandesfen),
    SPECIES_PAL(MAGIDASH, gMonPalette_Magidash),
    SPECIES_PAL(SERAPHURE, gMonPalette_Seraphure),
    SPECIES_PAL(HAGOOSH, gMonPalette_Hagoosh),
    SPECIES_PAL(HAGOOSH_VISCOUS, gMonPalette_HagooshViscous),
    SPECIES_PAL(WAKASUKA, gMonPalette_Wakasuka),
    SPECIES_PAL(DULLSOD, gMonPalette_Dullsod),
    SPECIES_PAL(BEVOLPIN, gMonPalette_Bevolpin),
    SPECIES_PAL(WATTL, gMonPalette_Wattl),
    SPECIES_PAL(XOLHM, gMonPalette_Xolhm),
    SPECIES_PAL(ODDIOWAVE, gMonPalette_Oddiowave),
    SPECIES_PAL(WHERML, gMonPalette_Wherml),
    SPECIES_PAL(CRUSTERROR, gMonPalette_Crusterror),
    SPECIES_PAL(MANTACORE, gMonPalette_Mantacore),
    SPECIES_PAL(SKULDUGERY, gMonPalette_Skuldugery),
    SPECIES_PAL(GRAVENDOR, gMonPalette_Gravendor),
    SPECIES_PAL(OGWON_ROCK, gMonPalette_OgwonRock),
    SPECIES_PAL(GRUBBLE, gMonPalette_Grubble),
    SPECIES_PAL(GRACKLIN, gMonPalette_Gracklin),
    SPECIES_PAL(SHAMBURGER, gMonPalette_Shamburger),
    SPECIES_PAL(FROZHORN, gMonPalette_Frozhorn),
    SPECIES_PAL(FROZFORCE, gMonPalette_Frozforce),
    SPECIES_PAL(STAALNARY, gMonPalette_Staalnary),
    SPECIES_PAL(BAROMITE, gMonPalette_Baromite),
    SPECIES_PAL(NAPALMITE, gMonPalette_Napalmite),
    SPECIES_PAL(STOVLARE, gMonPalette_Stovlare),
    SPECIES_PAL(ORBACLE, gMonPalette_Orbacle),
    SPECIES_PAL(NINOWN, gMonPalette_Ninown),
    SPECIES_PAL(CARDICT, gMonPalette_Cardict),
    SPECIES_PAL(POKERLORD, gMonPalette_Pokerlord),
    SPECIES_PAL(DEGOURGE, gMonPalette_Degourge),
    SPECIES_PAL(TUETUERROR, gMonPalette_Tuetuerror),
    SPECIES_PAL(BAGHOST, gMonPalette_Baghost),
    SPECIES_PAL(BAGHOUL, gMonPalette_Baghoul),
    SPECIES_PAL(WUVME, gMonPalette_Wuvme),
    SPECIES_PAL(VEEBLEN, gMonPalette_Veeblen),
    SPECIES_PAL(MALACHREY, gMonPalette_Malachrey),
    SPECIES_PAL(MALMARE, gMonPalette_Malmare),
    SPECIES_PAL(MALMARE_VIRUS, gMonPalette_MalmareVirus),
    SPECIES_PAL(SWEETAN, gMonPalette_Sweetan),
    SPECIES_PAL(MELCERALBA, gMonPalette_Melceralba),
    SPECIES_PAL(BUGGORY, gMonPalette_Buggory),
    SPECIES_PAL(ZAPPUG, gMonPalette_Zappug),
    SPECIES_PAL(PUPULZE, gMonPalette_Pupulze),
    SPECIES_PAL(RUBIMIZER, gMonPalette_Rubimizer),
    SPECIES_PAL(RICKSHAWTY, gMonPalette_Rickshawty),
    SPECIES_PAL(RICKSHAWTY_CHARIOT, gMonPalette_RickshawtyChariot),
    SPECIES_PAL(TREMITE, gMonPalette_Tremite),
    SPECIES_PAL(TROHIVE, gMonPalette_Trohive),
    SPECIES_PAL(CASTERMITE, gMonPalette_Castermite),
    SPECIES_PAL(EYESLIGHT, gMonPalette_Eyeslight),
    SPECIES_PAL(BEHOLZER, gMonPalette_Beholzer),
    SPECIES_PAL(EYERISH, gMonPalette_Eyerish),
    SPECIES_PAL(RETINEEL, gMonPalette_Retineel),
    SPECIES_PAL(ASTIGMORAY, gMonPalette_Astigmoray),
    SPECIES_PAL(ASTIGMORAY_BLIND, gMonPalette_AstigmorayBlind),
    SPECIES_PAL(GELECTUAL, gMonPalette_Gelectual),
    SPECIES_PAL(REBRR, gMonPalette_Rebrr),
    SPECIES_PAL(FERROFROS, gMonPalette_Ferrofros),
    SPECIES_PAL(FORTIFROS, gMonPalette_Fortifros),
    SPECIES_PAL(ARCTIKACK, gMonPalette_Arctikack),
    SPECIES_PAL(PRISMAPUP, gMonPalette_Prismapup),
    SPECIES_PAL(VIVIDAWG, gMonPalette_Vividawg),
    SPECIES_PAL(KITTEPUP, gMonPalette_Kittepup),
    SPECIES_PAL(PECKACHEW, gMonPalette_Peckachew),
    SPECIES_PAL(SKOOKY, gMonPalette_Skooky),
    SPECIES_PAL(VIZAAVISO, gMonPalette_Vizaaviso),
    SPECIES_PAL(SETATONKRE, gMonPalette_Setatonkre),
    SPECIES_PAL(PANZEEHEE, gMonPalette_Panzeehee),
    SPECIES_PAL(BABOBO, gMonPalette_Babobo),
    SPECIES_PAL(GROOSE, gMonPalette_Groose),
    SPECIES_PAL(GREESE, gMonPalette_Greese),
#endif
