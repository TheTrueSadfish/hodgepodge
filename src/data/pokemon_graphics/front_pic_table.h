const struct CompressedSpriteSheet gMonFrontPicTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SPRITE(GOOPER, gMonFrontPic_Gooper),
    SPECIES_SPRITE(SWISQUIRE, gMonFrontPic_Swisquire),
    SPECIES_SPRITE(MOG, gMonFrontPic_Mog),
    SPECIES_SPRITE(PROFUR, gMonFrontPic_Profur),
    SPECIES_SPRITE(CELSHRIOOM, gMonFrontPic_Celshrioom),
    SPECIES_SPRITE(DADALEMMA, gMonFrontPic_Dadalemma),
    SPECIES_SPRITE(CRAWTENDR, gMonFrontPic_Crawtendr),
    SPECIES_SPRITE(OKKAMIRIZO, gMonFrontPic_Okkamirizo),
    SPECIES_SPRITE(PLANTATORI, gMonFrontPic_Plantatori),
    SPECIES_SPRITE(SAPPOD, gMonFrontPic_Sappod),
    SPECIES_SPRITE(SHELBERT, gMonFrontPic_Shelbert),
    SPECIES_SPRITE(SHELEBRATE, gMonFrontPic_Shelebrate),
    SPECIES_SPRITE(SNORT_ALPACA, gMonFrontPic_SnortAlpaca),
    SPECIES_SPRITE(PLAINTAIN, gMonFrontPic_Plaintain),
    SPECIES_SPRITE(MUSALORD, gMonFrontPic_Musalord),
    SPECIES_SPRITE(BREVATO, gMonFrontPic_Brevato),
    SPECIES_SPRITE(KELPPY, gMonFrontPic_Kelppy),
    SPECIES_SPRITE(LURKELP, gMonFrontPic_Lurkelp),
    SPECIES_SPRITE(SHROOMOINK, gMonFrontPic_Shroomoink),
    SPECIES_SPRITE(SPORKE, gMonFrontPic_Sporke),
    SPECIES_SPRITE(CHERNOBOAR, gMonFrontPic_Chernoboar),
    SPECIES_SPRITE(BURSTAD, gMonFrontPic_Burstad),
    SPECIES_SPRITE(BLASTOAD, gMonFrontPic_Blastoad),
    SPECIES_SPRITE(EXPLOAD, gMonFrontPic_Expload),
    SPECIES_SPRITE(FBI_PENGUIN_1, gMonFrontPic_FBIPenguin1),
    SPECIES_SPRITE(FBI_PENGUIN_2, gMonFrontPic_FBIPenguin2),
    SPECIES_SPRITE(ICANDESFEN, gMonFrontPic_Icandesfen),
    SPECIES_SPRITE(MAGIDASH, gMonFrontPic_Magidash),
    SPECIES_SPRITE(SERAPHURE, gMonFrontPic_Seraphure),
    SPECIES_SPRITE(HAGOOSH, gMonFrontPic_Hagoosh),
    SPECIES_SPRITE(HAGOOSH_VISCOUS, gMonFrontPic_HagooshViscous),
    SPECIES_SPRITE(WAKASUKA, gMonFrontPic_Wakasuka),
    SPECIES_SPRITE(DULLSOD, gMonFrontPic_Dullsod),
    SPECIES_SPRITE(BEVOLPIN, gMonFrontPic_Bevolpin),
    SPECIES_SPRITE(WATTL, gMonFrontPic_Wattl),
    SPECIES_SPRITE(XOLHM, gMonFrontPic_Xolhm),
    SPECIES_SPRITE(ODDIOWAVE, gMonFrontPic_Oddiowave),
    SPECIES_SPRITE(WHERML, gMonFrontPic_Wherml),
    SPECIES_SPRITE(CRUSTERROR, gMonFrontPic_Crusterror),
    SPECIES_SPRITE(MANTACORE, gMonFrontPic_Mantacore),
    SPECIES_SPRITE(SKULDUGERY, gMonFrontPic_Skuldugery),
    SPECIES_SPRITE(GRAVENDOR, gMonFrontPic_Gravendor),
    SPECIES_SPRITE(OGWON_ROCK, gMonFrontPic_OgwonRock),
    SPECIES_SPRITE(GRUBBLE, gMonFrontPic_Grubble),
    SPECIES_SPRITE(GRACKLIN, gMonFrontPic_Gracklin),
    SPECIES_SPRITE(SHAMBURGER, gMonFrontPic_Shamburger),
    SPECIES_SPRITE(FROZHORN, gMonFrontPic_Frozhorn),
    SPECIES_SPRITE(FROZFORCE, gMonFrontPic_Frozforce),
    SPECIES_SPRITE(STAALNARY, gMonFrontPic_Staalnary),
    SPECIES_SPRITE(BAROMITE, gMonFrontPic_Baromite),
    SPECIES_SPRITE(NAPALMITE, gMonFrontPic_Napalmite),
    SPECIES_SPRITE(STOVLARE, gMonFrontPic_Stovlare),
    SPECIES_SPRITE(ORBACLE, gMonFrontPic_Orbacle),
    SPECIES_SPRITE(NINOWN, gMonFrontPic_Ninown),
    SPECIES_SPRITE(CARDICT, gMonFrontPic_Cardict),
    SPECIES_SPRITE(POKERLORD, gMonFrontPic_Pokerlord),
    SPECIES_SPRITE(DEGOURGE, gMonFrontPic_Degourge),
    SPECIES_SPRITE(TUETUERROR, gMonFrontPic_Tuetuerror),
    SPECIES_SPRITE(BAGHOST, gMonFrontPic_Baghost),
    SPECIES_SPRITE(BAGHOUL, gMonFrontPic_Baghoul),
    SPECIES_SPRITE(WUVME, gMonFrontPic_Wuvme),
    SPECIES_SPRITE(VEEBLEN, gMonFrontPic_Veeblen),
    SPECIES_SPRITE(MALACHREY, gMonFrontPic_Malachrey),
    SPECIES_SPRITE(MALMARE, gMonFrontPic_Malmare),
    SPECIES_SPRITE(MALMARE_VIRUS, gMonFrontPic_MalmareVirus),
    SPECIES_SPRITE(SWEETAN, gMonFrontPic_Sweetan),
    SPECIES_SPRITE(MELCERALBA, gMonFrontPic_Melceralba),
    SPECIES_SPRITE(BUGGORY, gMonFrontPic_Buggory),
    SPECIES_SPRITE(ZAPPUG, gMonFrontPic_Zappug),
    SPECIES_SPRITE(PUPULZE, gMonFrontPic_Pupulze),
    SPECIES_SPRITE(RUBIMIZER, gMonFrontPic_Rubimizer),
    SPECIES_SPRITE(RICKSHAWTY, gMonFrontPic_Rickshawty),
    SPECIES_SPRITE(RICKSHAWTY_CHARIOT, gMonFrontPic_RickshawtyChariot),
    SPECIES_SPRITE(TREMITE, gMonFrontPic_Tremite),
    SPECIES_SPRITE(TROHIVE, gMonFrontPic_Trohive),
    SPECIES_SPRITE(CASTERMITE, gMonFrontPic_Castermite),
    SPECIES_SPRITE(EYESLIGHT, gMonFrontPic_Eyeslight),
    SPECIES_SPRITE(BEHOLZER, gMonFrontPic_Beholzer),
    SPECIES_SPRITE(EYERISH, gMonFrontPic_Eyerish),
    SPECIES_SPRITE(RETINEEL, gMonFrontPic_Retineel),
    SPECIES_SPRITE(ASTIGMORAY, gMonFrontPic_Astigmoray),
    SPECIES_SPRITE(ASTIGMORAY_BLIND, gMonFrontPic_AstigmorayBlind),
    SPECIES_SPRITE(GELECTUAL, gMonFrontPic_Gelectual),
    SPECIES_SPRITE(REBRR, gMonFrontPic_Rebrr),
    SPECIES_SPRITE(FERROFROS, gMonFrontPic_Ferrofros),
    SPECIES_SPRITE(FORTIFROS, gMonFrontPic_Fortifros),
    SPECIES_SPRITE(ARCTIKACK, gMonFrontPic_Arctikack),
    SPECIES_SPRITE(PRISMAPUP, gMonFrontPic_Prismapup),
    SPECIES_SPRITE(VIVIDAWG, gMonFrontPic_Vividawg),
    SPECIES_SPRITE(KITTEPUP, gMonFrontPic_Kittepup),
    SPECIES_SPRITE(PECKACHEW, gMonFrontPic_Peckachew),
    SPECIES_SPRITE(SKOOKY, gMonFrontPic_Skooky),
    SPECIES_SPRITE(VIZAAVISO, gMonFrontPic_Vizaaviso),
    SPECIES_SPRITE(SETATONKRE, gMonFrontPic_Setatonkre),
    SPECIES_SPRITE(PANZEEHEE, gMonFrontPic_Panzeehee),
    SPECIES_SPRITE(BABOBO, gMonFrontPic_Babobo),
    SPECIES_SPRITE(GROOSE, gMonFrontPic_Groose),
    SPECIES_SPRITE(GREESE, gMonFrontPic_Greese),
#endif
