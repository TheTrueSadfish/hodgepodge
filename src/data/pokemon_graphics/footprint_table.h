const u8 *const gMonFootprintTable[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_GOOPER] = gMonFootprint_Gooper,
    [SPECIES_SWISQUIRE] = gMonFootprint_Swisquire,
    [SPECIES_MOG] = gMonFootprint_Mog,
    [SPECIES_PROFUR] = gMonFootprint_Profur,
    [SPECIES_CELSHRIOOM] = gMonFootprint_Celshrioom,
    [SPECIES_DADALEMMA] = gMonFootprint_Dadalemma,
    [SPECIES_CRAWTENDR] = gMonFootprint_Crawtendr,
    [SPECIES_OKKAMIRIZO] = gMonFootprint_Okkamirizo,
    [SPECIES_PLANTATORI] = gMonFootprint_Plantatori,
    [SPECIES_SAPPOD] = gMonFootprint_Sappod,
    [SPECIES_SHELBERT] = gMonFootprint_Shelbert,
    [SPECIES_SHELEBRATE] = gMonFootprint_Shelebrate,
    [SPECIES_SNORT_ALPACA] = gMonFootprint_SnortAlpaca,
    [SPECIES_PLAINTAIN] = gMonFootprint_Plaintain,
    [SPECIES_MUSALORD] = gMonFootprint_Musalord,
    [SPECIES_BREVATO] = gMonFootprint_Brevato,
    [SPECIES_KELPPY] = gMonFootprint_Kelppy,
    [SPECIES_LURKELP] = gMonFootprint_Lurkelp,
    [SPECIES_SHROOMOINK] = gMonFootprint_Shroomoink,
    [SPECIES_SPORKE] = gMonFootprint_Sporke,
    [SPECIES_CHERNOBOAR] = gMonFootprint_Chernoboar,
    [SPECIES_BURSTAD] = gMonFootprint_Burstad,
    [SPECIES_BLASTOAD] = gMonFootprint_Blastoad,
    [SPECIES_EXPLOAD] = gMonFootprint_Expload,
    [SPECIES_FBI_PENGUIN_1] = gMonFootprint_FBIPenguin1,
    [SPECIES_FBI_PENGUIN_2] = gMonFootprint_FBIPenguin2,
    [SPECIES_ICANDESFEN] = gMonFootprint_Icandesfen,
    [SPECIES_MAGIDASH] = gMonFootprint_Magidash,
    [SPECIES_SERAPHURE] = gMonFootprint_Seraphure,
    [SPECIES_HAGOOSH] = gMonFootprint_Hagoosh,
    [SPECIES_WAKASUKA] = gMonFootprint_Wakasuka,
    [SPECIES_DULLSOD] = gMonFootprint_Dullsod,
    [SPECIES_BEVOLPIN] = gMonFootprint_Bevolpin,
    [SPECIES_WATTL] = gMonFootprint_Wattl,
    [SPECIES_XOLHM] = gMonFootprint_Xolhm,
    [SPECIES_ODDIOWAVE] = gMonFootprint_Oddiowave,
    [SPECIES_WHERML] = gMonFootprint_Wherml,
    [SPECIES_CRUSTERROR] = gMonFootprint_Crusterror,
    [SPECIES_MANTACORE] = gMonFootprint_Mantacore,
    [SPECIES_SKULDUGERY] = gMonFootprint_Skeldugery,
    [SPECIES_GRAVENDOR] = gMonFootprint_Gravendor,
    [SPECIES_OGWON_ROCK] = gMonFootprint_OgwonRock,
    [SPECIES_GRUBBLE] = gMonFootprint_Grubble,
    [SPECIES_GRACKLIN] = gMonFootprint_Gracklin,
    [SPECIES_SHAMBURGER] = gMonFootprint_Shamburger,
    [SPECIES_FROZHORN] = gMonFootprint_Frozhorn,
    [SPECIES_FROZFORCE] = gMonFootprint_Frozforce,
    [SPECIES_STAALNARY] = gMonFootprint_Staalnary,
    [SPECIES_BAROMITE] = gMonFootprint_Baromite,
    [SPECIES_NAPALMITE] = gMonFootprint_Napalmite,
    [SPECIES_STOVLARE] = gMonFootprint_Stovlare,
    [SPECIES_ORBACLE] = gMonFootprint_Orbacle,
    [SPECIES_NINOWN] = gMonFootprint_Ninown,
    [SPECIES_CARDICT] = gMonFootprint_Cardict,
    [SPECIES_POKERLORD] = gMonFootprint_Pokerlord,
    [SPECIES_DEGOURGE] = gMonFootprint_Degourge,
    [SPECIES_TUETUERROR] = gMonFootprint_Tuetuerror,
    [SPECIES_BAGHOST] = gMonFootprint_Baghost,
    [SPECIES_BAGHOUL] = gMonFootprint_Baghoul,
    [SPECIES_WUVME] = gMonFootprint_Wuvme,
    [SPECIES_VEEBLEN] = gMonFootprint_Veeblen,
    [SPECIES_MALACHREY] = gMonFootprint_Malachrey,
    [SPECIES_MALMARE] = gMonFootprint_Malmare,
    [SPECIES_SWEETAN] = gMonFootprint_Sweetan,
    [SPECIES_MELCERALBA] = gMonFootprint_Melceralba,
    [SPECIES_BUGGORY] = gMonFootprint_Buggory,
    [SPECIES_ZAPPUG] = gMonFootprint_Zappug,
    [SPECIES_PUPULZE] = gMonFootprint_Pupulze,
    [SPECIES_RUBIMIZER] = gMonFootprint_Rubimizer,
    [SPECIES_RICKSHAWTY] = gMonFootprint_Rickshawty,
    [SPECIES_TREMITE] = gMonFootprint_Tremite,
    [SPECIES_TROHIVE] = gMonFootprint_Trohive,
    [SPECIES_CASTERMITE] = gMonFootprint_Castermite,
    [SPECIES_EYESLIGHT] = gMonFootprint_Eyeslight,
    [SPECIES_BEHOLZER] = gMonFootprint_Beholzer,
    [SPECIES_EYERISH] = gMonFootprint_Eyerish,
    [SPECIES_RETINEEL] = gMonFootprint_Retineel,
    [SPECIES_ASTIGMORAY] = gMonFootprint_Astigmoray,
    [SPECIES_GELECTUAL] = gMonFootprint_Gelectual,
    [SPECIES_REBRR] = gMonFootprint_Rebrr,
    [SPECIES_FERROFROS] = gMonFootprint_Ferrofros,
    [SPECIES_FORTIFROS] = gMonFootprint_Fortifros,
    [SPECIES_ARCTIKACK] = gMonFootprint_Arctikack,
    [SPECIES_PRISMAPUP] = gMonFootprint_Prismapup,
    [SPECIES_VIVIDAWG] = gMonFootprint_Vividawg,
    [SPECIES_KITTEPUP] = gMonFootprint_Kittepup,
    [SPECIES_PECKACHEW] = gMonFootprint_Peckachew,
    [SPECIES_SKOOKY] = gMonFootprint_Skooky,
    [SPECIES_VIZAAVISO] = gMonFootprint_Vizaaviso,
    [SPECIES_SETATONKRE] = gMonFootprint_Setatonkre,
    [SPECIES_PANZEEHEE] = gMonFootprint_Panzeehee,
    [SPECIES_BABOBO] = gMonFootprint_Babobo,
    [SPECIES_GROOSE] = gMonFootprint_Groose,
    [SPECIES_GREESE] = gMonFootprint_Greese,
#endif
