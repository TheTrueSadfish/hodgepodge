const struct CompressedSpriteSheet gMonBackPicTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SPRITE(GOOPER, gMonBackPic_Gooper),
    SPECIES_SPRITE(SWISQUIRE, gMonBackPic_Swisquire),
    SPECIES_SPRITE(MOG, gMonBackPic_Mog),
    SPECIES_SPRITE(PROFUR, gMonBackPic_Profur),
    SPECIES_SPRITE(CELSHRIOOM, gMonBackPic_Celshrioom),
    SPECIES_SPRITE(DADALEMMA, gMonBackPic_Dadalemma),
    SPECIES_SPRITE(CRAWTENDR, gMonBackPic_Crawtendr),
    SPECIES_SPRITE(OKKAMIRIZO, gMonBackPic_Okkamirizo),
    SPECIES_SPRITE(PLANTATORI, gMonBackPic_Plantatori),
    SPECIES_SPRITE(SAPPOD, gMonBackPic_Sappod),
    SPECIES_SPRITE(SHELBERT, gMonBackPic_Shelbert),
    SPECIES_SPRITE(SHELEBRATE, gMonBackPic_Shelebrate),
    SPECIES_SPRITE(SNORT_ALPACA, gMonBackPic_SnortAlpaca),
    SPECIES_SPRITE(PLAINTAIN, gMonBackPic_Plaintain),
    SPECIES_SPRITE(MUSALORD, gMonBackPic_Musalord),
    SPECIES_SPRITE(BREVATO, gMonBackPic_Brevato),
    SPECIES_SPRITE(KELPPY, gMonBackPic_Kelppy),
    SPECIES_SPRITE(LURKELP, gMonBackPic_Lurkelp),
    SPECIES_SPRITE(SHROOMOINK, gMonBackPic_Shroomoink),
    SPECIES_SPRITE(SPORKE, gMonBackPic_Sporke),
    SPECIES_SPRITE(CHERNOBOAR, gMonBackPic_Chernoboar),
    SPECIES_SPRITE(BURSTAD, gMonBackPic_Burstad),
    SPECIES_SPRITE(BLASTOAD, gMonBackPic_Blastoad),
    SPECIES_SPRITE(EXPLOAD, gMonBackPic_Expload),
    SPECIES_SPRITE(FBI_PENGUIN_1, gMonBackPic_FBIPenguin1),
    SPECIES_SPRITE(FBI_PENGUIN_2, gMonBackPic_FBIPenguin2),
    SPECIES_SPRITE(ICANDESFEN, gMonBackPic_Icandesfen),
    SPECIES_SPRITE(MAGIDASH, gMonBackPic_Magidash),
    SPECIES_SPRITE(SERAPHURE, gMonBackPic_Seraphure),
    SPECIES_SPRITE(HAGOOSH, gMonBackPic_Hagoosh),
    SPECIES_SPRITE(HAGOOSH_VISCOUS, gMonBackPic_HagooshViscous),
    SPECIES_SPRITE(WAKASUKA, gMonBackPic_Wakasuka),
    SPECIES_SPRITE(DULLSOD, gMonBackPic_Dullsod),
    SPECIES_SPRITE(BEVOLPIN, gMonBackPic_Bevolpin),
    SPECIES_SPRITE(WATTL, gMonBackPic_Wattl),
    SPECIES_SPRITE(XOLHM, gMonBackPic_Xolhm),
    SPECIES_SPRITE(ODDIOWAVE, gMonBackPic_Oddiowave),
    SPECIES_SPRITE(WHERML, gMonBackPic_Wherml),
    SPECIES_SPRITE(CRUSTERROR, gMonBackPic_Crusterror),
    SPECIES_SPRITE(MANTACORE, gMonBackPic_Mantacore),
    SPECIES_SPRITE(SKULDUGERY, gMonBackPic_Skuldugery),
    SPECIES_SPRITE(GRAVENDOR, gMonBackPic_Gravendor),
    SPECIES_SPRITE(OGWON_ROCK, gMonBackPic_OgwonRock),
    SPECIES_SPRITE(GRUBBLE, gMonBackPic_Grubble),
    SPECIES_SPRITE(GRACKLIN, gMonBackPic_Gracklin),
    SPECIES_SPRITE(SHAMBURGER, gMonBackPic_Shamburger),
    SPECIES_SPRITE(FROZHORN, gMonBackPic_Frozhorn),
    SPECIES_SPRITE(FROZFORCE, gMonBackPic_Frozforce),
    SPECIES_SPRITE(STAALNARY, gMonBackPic_Staalnary),
    SPECIES_SPRITE(BAROMITE, gMonBackPic_Baromite),
    SPECIES_SPRITE(NAPALMITE, gMonBackPic_Napalmite),
    SPECIES_SPRITE(STOVLARE, gMonBackPic_Stovlare),
    SPECIES_SPRITE(ORBACLE, gMonBackPic_Orbacle),
    SPECIES_SPRITE(NINOWN, gMonBackPic_Ninown),
    SPECIES_SPRITE(CARDICT, gMonBackPic_Cardict),
    SPECIES_SPRITE(POKERLORD, gMonBackPic_Pokerlord),
    SPECIES_SPRITE(DEGOURGE, gMonBackPic_Degourge),
    SPECIES_SPRITE(TUETUERROR, gMonBackPic_Tuetuerror),
    SPECIES_SPRITE(BAGHOST, gMonBackPic_Baghost),
    SPECIES_SPRITE(BAGHOUL, gMonBackPic_Baghoul),
    SPECIES_SPRITE(WUVME, gMonBackPic_Wuvme),
    SPECIES_SPRITE(VEEBLEN, gMonBackPic_Veeblen),
    SPECIES_SPRITE(MALACHREY, gMonBackPic_Malachrey),
    SPECIES_SPRITE(MALMARE, gMonBackPic_Malmare),
    SPECIES_SPRITE(MALMARE_VIRUS, gMonBackPic_MalmareVirus),
    SPECIES_SPRITE(SWEETAN, gMonBackPic_Sweetan),
    SPECIES_SPRITE(MELCERALBA, gMonBackPic_Melceralba),
    SPECIES_SPRITE(BUGGORY, gMonBackPic_Buggory),
    SPECIES_SPRITE(ZAPPUG, gMonBackPic_Zappug),
    SPECIES_SPRITE(PUPULZE, gMonBackPic_Pupulze),
    SPECIES_SPRITE(RUBIMIZER, gMonBackPic_Rubimizer),
    SPECIES_SPRITE(RICKSHAWTY, gMonBackPic_Rickshawty),
    SPECIES_SPRITE(RICKSHAWTY_CHARIOT, gMonBackPic_RickshawtyChariot),
    SPECIES_SPRITE(TREMITE, gMonBackPic_Tremite),
    SPECIES_SPRITE(TROHIVE, gMonBackPic_Trohive),
    SPECIES_SPRITE(CASTERMITE, gMonBackPic_Castermite),
    SPECIES_SPRITE(EYESLIGHT, gMonBackPic_Eyeslight),
    SPECIES_SPRITE(BEHOLZER, gMonBackPic_Beholzer),
    SPECIES_SPRITE(EYERISH, gMonBackPic_Eyerish),
    SPECIES_SPRITE(RETINEEL, gMonBackPic_Retineel),
    SPECIES_SPRITE(ASTIGMORAY, gMonBackPic_Astigmoray),
    SPECIES_SPRITE(ASTIGMORAY_BLIND, gMonBackPic_AstigmorayBlind),
    SPECIES_SPRITE(GELECTUAL, gMonBackPic_Gelectual),
    SPECIES_SPRITE(REBRR, gMonBackPic_Rebrr),
    SPECIES_SPRITE(FERROFROS, gMonBackPic_Ferrofros),
    SPECIES_SPRITE(FORTIFROS, gMonBackPic_Fortifros),
    SPECIES_SPRITE(ARCTIKACK, gMonBackPic_Arctikack),
    SPECIES_SPRITE(PRISMAPUP, gMonBackPic_Prismapup),
    SPECIES_SPRITE(VIVIDAWG, gMonBackPic_Vividawg),
    SPECIES_SPRITE(KITTEPUP, gMonBackPic_Kittepup),
    SPECIES_SPRITE(PECKACHEW, gMonBackPic_Peckachew),
    SPECIES_SPRITE(SKOOKY, gMonBackPic_Skooky),
    SPECIES_SPRITE(VIZAAVISO, gMonBackPic_Vizaaviso),
    SPECIES_SPRITE(SETATONKRE, gMonBackPic_Setatonkre),
    SPECIES_SPRITE(PANZEEHEE, gMonBackPic_Panzeehee),
    SPECIES_SPRITE(BABOBO, gMonBackPic_Babobo),
    SPECIES_SPRITE(GROOSE, gMonBackPic_Groose),
    SPECIES_SPRITE(GREESE, gMonBackPic_Greese),
#endif
...
#endif
    SPECIES_SPRITE(EGG, gMonBackPic_Eggneggma),
};
