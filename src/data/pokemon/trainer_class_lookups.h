const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_VANDAL] = TRAINER_PIC_HOODLUM,
    ...
    [FACILITY_CLASS_CLOWN] = TRAINER_PIC_CLOWN,
    [FACILITY_CLASS_DAME] = TRAINER_PIC_DAME,
    [FACILITY_CLASS_AGENT] = TRAINER_PIC_AGENT,
    [FACILITY_CLASS_BARRY] = TRAINER_PIC_BARRY,
    [FACILITY_CLASS_MASTER] = TRAINER_PIC_EXPERT_M,
    [FACILITY_CLASS_SMITHY] = TRAINER_PIC_SMITHY,
    [FACILITY_CLASS_SANE] = TRAINER_PIC_SANE,
    [FACILITY_CLASS_OFFICER] = TRAINER_PIC_OFFICER,
    [FACILITY_CLASS_PHOTOGRAPHER] = TRAINER_PIC_PHOTOGRAPHER,
    [FACILITY_CLASS_THE_HEALER] = TRAINER_PIC_THE_HEALER,
    [FACILITY_CLASS_ELDER] = TRAINER_PIC_ELDER,
    [FACILITY_CLASS_SOLDIER] = TRAINER_PIC_SOLDIER,
    [FACILITY_CLASS_GRILLMEISTER] = TRAINER_PIC_GRILLMEISTER,
    [FACILITY_CLASS_ASSISTANT] = TRAINER_PIC_ANGELA,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_VANDAL] = TRAINER_CLASS_HOODLUM,
    ...
    [FACILITY_CLASS_CLOWN] = TRAINER_CLASS_CLOWN,
    [FACILITY_CLASS_DAME] = TRAINER_CLASS_DAME,
    [FACILITY_CLASS_AGENT] = TRAINER_CLASS_AGENT,
    [FACILITY_CLASS_BARRY] = TRAINER_CLASS_BARRY,
    [FACILITY_CLASS_MASTER] = TRAINER_CLASS_EXPERT,
    [FACILITY_CLASS_SMITHY] = TRAINER_CLASS_SMITHY,
    [FACILITY_CLASS_SANE] = TRAINER_CLASS_SANE,
    [FACILITY_CLASS_OFFICER] = TRAINER_CLASS_OFFICER,
    [FACILITY_CLASS_PHOTOGRAPHER] = TRAINER_CLASS_PHOTOGRAPHER,
    [FACILITY_CLASS_THE_HEALER] = TRAINER_CLASS_THE_HEALER,
    [FACILITY_CLASS_ELDER] = TRAINER_CLASS_ELDER,
    [FACILITY_CLASS_SOLDIER] = TRAINER_CLASS_SOLDIER,
    [FACILITY_CLASS_GRILLMEISTER] = TRAINER_CLASS_GRILLMEISTER,
    [FACILITY_CLASS_ASSISTANT] = TRAINER_CLASS_RESEARCHER,
};
