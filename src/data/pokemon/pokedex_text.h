...
const u8 gCharmanderPokedexText[] = _(
    "The flame that burns at the tip of their tails\n"
    "is an indication of their emotions. The flame\n"
    "wavers when they are enjoying themselves. If\n"
    "these Pokémon become enraged, the flame burns\n"
    "fiercely.");

const u8 gCharmeleonPokedexText[] = _(
    "Charmeleon mercilessly destroys their foes using\n"
    "their sharp claws. If they encounter a powerful\n"
    "foe, they turn aggressive. In this excited\n"
    "state, the flame at the tip of their tail flares\n"
    "with a bluish-white color.");

const u8 gCharizardPokedexText[] = _(
	"A form of Charizard born from abandonment. They\n"
	"have mastered the powers of ice and frost, now\n"
	"roaming mountains, attempting to seek out and\n"
	"take revenge on the ones that cast them aside.");
...
const u8 gEkansPokedexText[] = _(
	"They fly using a cloud of smoke conjured from\n"
	"within their lungs. They were first found in the\n"
	"cloud layer above Mauville City, thought to have\n"
	"resulted from an increasing amount of hazardous\n"
	"city smog.");

const u8 gArbokPokedexText[] = _(
	"While most snake Pokémon release venom\n"
	"exclusively through their fangs, the dangerous\n"
	"La Roc species have evolved the ability to\n"
	"release gas that can cause prey to faint in a\n"
	"matter of seconds from their mouth.");
...
const u8 gSeelPokedexText[] = _(
	"Dreel are a rare species of Pokémon that are\n"
	"only found on 1 island chain in the world. They\n"
	"have a weak venomous bite, and their green,\n"
	"patterned hide makes for popular clothing\n"
	"material in their native islands.");

const u8 gDewgongPokedexText[] = _(
	"Dragong eat by swallowing anything they hunt\n"
	"down whole. Their venom is strong enough to\n"
	"knock out a Pokémon many times its size, and\n"
	"they can withstand strands of highly potent\n"
	"poison.");
...
const u8 gTangelaPokedexText[] = _(
	"Tentangle float buoyantly and aimlessly out in\n"
	"the ocean. When perturbed, they will spin\n"
	"furiously, whipping their foe with their\n"
	"tentacles until left alone. After this, they\n"
	"will go back to calm aimless drifting.");
...
const u8 gStaryuPokedexText[] = _(
	"It's said that if you see a pink mist in a\n"
	"dream, a Staream has begun to consume it. Those\n"
	"who are adept at dreaming vividly can ward them\n"
	"off.");

const u8 gStarmiePokedexText[] = _(
	"They use their ability to enter dreams to turn\n"
	"them into nightmares based on the host's fears\n"
	"and insecurities, feeding off of the intense\n"
	"negativity they create.");
...
const u8 gPorygonPokedexText[] = _(
	"A synthetic Pokémon created by trainers in\n"
	"Galar's Spikemuth District to battle in\n"
	"high-stakes betting events. The saw blade on\n"
	"their tail can be swapped out for other\n"
	"weaponry.");
...
const u8 gMurkrowPokedexText[] = _(
	"Magekrow have 114 variations of their caws that\n"
	"they can recite in specific orders to cast\n"
	"arcane spells. Humans attempting to replicate\n"
	"these incantations will have their voices taken\n"
	"away.");
...
const u8 gMisdreavusPokedexText[] = _(
	"These Pokémon are known for their beautiful\n"
	"singing, which holds the power to heal wounds.\n"
	"Some say they can use this same power to inflict\n"
	"harm as well, but this isn't well documented.");
...
const u8 gCorsolaPokedexText[] = _(
	"Packs of Calfsola are utilized in forested,\n"
	"wintry regions to haul supplies on sleighs. They\n"
	"are extremely loyal but need a steady supply of\n"
	"pine needles to be kept fed.");
...
const u8 gPorygon2PokedexText[] = _(
	"PorybotV2 represent a significantly improved\n"
	"attempt at a battling bot Pokémon compared to\n"
	"their predecessor. Their form allows them to set\n"
	"and maneuver through whatever terrain they see\n"
	"fit.");
...
const u8 gCacneaPokedexText[] = _(
	"These Pokémon attack normally by screaming their\n"
	"lungs out, which generates a potent heat from\n"
	"their vocal cords, releasing as flames. They\n"
	"commonly scare those who find it.");

const u8 gCacturnePokedexText[] = _(
	"A scheming fool of fire and trickery. The very\n"
	"sap it churns within its chambered fibers\n"
	"ignites with malicious heat. Lobbing and tossing\n"
	"balls of fire at the hapless purely for its\n"
	"jollies.");
...
const u8 gMawilePokedexText[] = _(
	"According to legends, Bloomwile are the spirits\n"
	"of ancient Mawile, wiped out long ago by early\n"
	"man out of fear. To this day they lie in wait,\n"
	"luring lost travelers into the woods, never to\n"
	"return.");
...
const u8 gGulpinPokedexText[] = _(
	"Gulgan breathe much like a heartbeat, their\n"
	"entire body convulsing each beat. They cannot\n"
	"consume anything acidic, for it will cause\n"
	"painful heartburn. Oddly, they don't need to eat\n"
	"to survive, only for pleasure.");

const u8 gSwalotPokedexText[] = _(
	"The viscous substance produced by a Swalheart is\n"
	"said to heal any ailment if swallowed. This is\n"
	"easier said than done, as this substance tastes\n"
	"so indescribably awful that it makes most throw\n"
	"it right back up.");
...
const u8 gAronPokedexText[] = _(
    "Aron have bodies of steel. With one all-out\n"
    "charge, these Pokémon can demolish even a heavy\n"
    "dump truck. The destroyed dump truck then\n"
    "becomes a handy meal for these Pokémon.");

const u8 gLaironPokedexText[] = _(
    "Lairon feed on iron contained in rocks and\n"
    "water. They make their nests in mountains where\n"
    "iron ore is buried. As a result, these Pokémon\n"
    "often clash with humans mining the iron ore.");

const u8 gAggronPokedexText[] = _(
	"Smaugron living within volcanos have adapted\n"
	"from eating steel, and instead, now feast on the\n"
	"plentiful reserves of magma in their habitats.\n"
	"This has led them to shed their steel armor,\n"
	"thus igniting their inner fire.");
...
const u8 gRaltsPokedexText[] = _(
	"Deep in the ocean, where daylight breaks not\n"
	"even the dark, a curious flittering light bobs\n"
	"up and down. Many are compelled to visit this\n"
	"curious bit of light. The light, however, is more\n"
	"cruel and cunning than what hides in the dark.");

const u8 gKirliaPokedexText[] = _(
	"Night, the dreaded hours, the bane of sailors.\n"
	"The long pause eats away at one's sanity. These\n"
	"pelagic pests are savages yet, they are sly, so\n"
	"they wait. Soon dawn, a relief most welcome, yet\n"
	"is it truly the light?");

const u8 gGardevoirPokedexText[] = _(
	"The ocean brews many evils, but none so devious\n"
	"as the betrayal of beauty. In storms of waves\n"
	"and thunder, a voice, luring, elfin, tickles the\n"
	"pining hearts of men. Soon, the black waters\n"
	"embrace their madness and their tired life.");
...
const u8 gMismagiusPokedexText[] = _(
	"They roam the land in search of ill people and\n"
	"Pokémon, absorbing their sickness and releasing\n"
	"it where it can't hurt anyone. Some say this\n"
	"treatment comes at a price, but none know what\n"
	"that may be.");

const u8 gHonchkrowPokedexText[] = _(
	"Up in wooded mountains lays a wizened warlock of\n"
	"interminable knowledge. Do not mistake it for a\n"
	"conjurer of cheap tricks, as it is a vicar of\n"
	"great ancient arts. It has guided many greats of\n"
	"the past, so pay respects to this old avian.");
...
const u8 gTangrowthPokedexText[] = _(
	"A typical Jaramari is extremely cunning,\n"
	"slipping about the battlefield in odd and\n"
	"unorthodox ways to perplex their opponent\n"
	"before whipping them into paralysis and\n"
	"finishing them with strangulation.");
...
const u8 gGalladePokedexText[] = _(
	"Through harsh waves and winds, weathered sailors\n"
	"brace for the coming glimmer within the tempest.\n"
	"That light... it is no sign of hope, no respite\n"
	"from the storm, but the darkness that drags you\n"
...
const u8 gPatratPokedexText[] = _(
	"In the Age of Maritime trade, unwanted stowaways\n"
	"sailed to uncharted places. Ample fruit in odd\n"
	"lands allowed propagation and prosperity. Not\n"
	"all are fortunate, however. In an isolated land,\n"
	"malice waits for a visit, a host.");

const u8 gWatchogPokedexText[] = _(
	"The unwanted stowaway sees more than what lies\n"
	"in front. This supernatural foresight has made\n"
	"it an uncanny foe, striking first with psionic\n"
	"strength. It times its attacks to the enemy's\n"
	"movements, guaranteeing a deadly blow.");
...
const u8 gTynamoPokedexText[] = _(
	"Their sparks aren't very bright yet, and they're\n"
	"much more cautious than their evolved forms.\n"
	"Despite this, Sparx still have a strong sense of\n"
	"confidence in themselves.");

const u8 gEelektrikPokedexText[] = _(
	"Strong sparks flare from the tip of their tails.\n"
	"They show their power to their peers by crashing\n"
	"headfirst into large rocks in an attempt to\n"
	"destroy them. The impact leaves behind colorful\n"
	"embers.");

const u8 gEelektrossPokedexText[] = _(
	"Luxstrobe are careful and calculated. They can\n"
	"destroy boulders with ease, detonating them with\n"
	"a loud crash. The brightness of their sparks is\n"
...
const u8 gVolcaronaPokedexText[] = _(
	"Their bodies have evolved solely to fly\n"
	"soundlessly in high altitudes. If a Wyrm Wing\n"
	"ever becomes grounded, it will helplessly flop\n"
	"about like a fish out of water. They are said to\n"
	"have been more common sights in medieval times.");
...
const u8 gPumpkabooPokedexText[] = _(
	"Pumpkagoo will gather in abandoned towers,\n"
	"setting up vats to brew more of their kind. The\n"
	"recipe calls for Hagoosh fluids, Dragong hide,\n"
	"and Capybarna bones.");

const u8 gGourgeistPokedexText[] = _(
	"Alchemists who are truly disciplined and skilled\n"
	"at their craft are said to become Googeist after\n"
	"their passing, their skulls remaining suspended\n"
	"in ooze for eternity. Whether this is a blessing\n"
	"or curse varies.");
...
const u8 gPyukumukuPokedexText[] = _(
	"Fluids cover their bodies, which allows them to\n"
	"stay slick and hydrated for long periods. They\n"
	"are fond of spitting out their stomachs to smack\n"
	"foes in the face.");
...
const u8 gCursolaPokedexText[] = _(
	"Local legend once speculated that these Pokémon\n"
	"had x-ray vision because of their manic eyes.\n"
	"Coorse antlers are primarily composed of\n"
	"aragonite, implying a recent aquatic ancestor.");
...
const u8 gRegidragoPokedexText[] = _(
	"This Pokémon is a man-made attempt to complete\n"
	"Regidrago and release its true form. Despite its\n"
	"immense power, this Pokémon requires a ludicrous\n"
	"amount of energy to function, thus it remains\n"
	"mostly in stasis.");
...
const u8 gGooperPokedexText[] = _(
	...
	"and Patrat... luckily, they do not seem to\n"
...
const u8 gBrevatoPokedexText[] = _(
	"They're often found sunbathing with their heads\n"
	"peeking above the dirt. When disturbed, they'll\n"
	"grab the intruder from underground by extending\n"
	"their root limbs, and promptly chuck the sod out\n"
	"of range.");

const u8 gKelppyPokedexText[] = _(
	"A species of fish Pokémon similar in aesthetics\n"
	"to Magikarp that are found exclusively deep\n"
	"underwater. Unlike Magikarp, a Kelppy's cells\n"
	"are more akin to those of plants, though they do\n"
	"not require sunlight to thrive.");

const u8 gLurkelpPokedexText[] = _(
	"Lying in wait at the bottom of the darkest\n"
	"trenches of the ocean are these terrifying\n"
	"predators. Lurkelp lack ample company so far in\n"
	"the depths, and as a result, are always\n"
	"ravenously famished.");

const u8 gShroomoinkPokedexText[] = _(
	"These Pokémon are friendly to humans, but huff\n"
	"smelly and hazardous gas to plant life. They\n"
	"are only kept as pets in very urban areas.");

const u8 gSporkePokedexText[] = _(
	"Their noxious fumes are only dangerous to plants\n"
	"and Grass-type Pokémon. With their meat being\n"
	"revered as a delicacy, the bulk of the captive\n"
	"Sporke population is carefully quarantined and\n"
	"cultivated.");

const u8 gChernoboarPokedexText[] = _(
	"Chernoboar are seldom seen in the wild, once in\n"
	"a blue moon. If one does not perish peacefully,\n"
	"it will explode, spreading deadly nuclear\n"
	"radiation in a sizable radius surrounding it.");

const u8 gIcandesfenPokedexText[] = _(
	"When in a scuffle, these Pokémon can heat their\n"
	"armor to 900+ degrees Fahrenheit, until they\n"
	"become colored a radiant red. Icandesfen live in\n"
	"island volcanoes, swimming through water and\n"
	"lava alike.");

const u8 gSeraphurePokedexText[] = _(
	"One drop of a Seraphure's body can purify even\n"
	"the most toxic waters. Many devout venerate them\n"
	"as the healing hands of the divine. Scientists,\n"
	"on the other hand, study them for their\n"
	"incredible purifying properties.");

const u8 gWakasukaPokedexText[] = _(
	"Wakasuka have five brains, one in each branch of\n"
	"their internal organ system, that they freely\n"
	"control like arms. Wakasuka are clever beings\n"
	"who can learn sign language with enough love and\n"
	"care, though they are also capable of mischief.");

const u8 gWattlPokedexText[] = _(
	"Thought to be a close relative of Wooper, they\n"
	"live in secluded underground caves. Wattl have\n"
	"no need for sight in this environment, so they\n"
	"use electrical pulses to map out their\n"
	"surroundings.");

const u8 gXolhmPokedexText[] = _(
	"Completely blind, it is thought that their gills\n"
	"can sense the souls of those around them.\n"
	"Mythology considered them beasts from the\n"
	"underworld, adopting their skeletal face as a\n"
	"symbol of disaster and misfortune.");

const u8 gOddiowavePokedexText[] = _(
	"Wild Oddiowave live in seldom-populated rural\n"
	"areas and broadcast eerie sounds to local radio\n"
	"frequencies. Those who tune in and listen report\n"
	"seeing strange hallucinations and vivid dreams.");

const u8 gWhermlPokedexText[] = _(
	"Wherml are small, mild-mannered Pokémon. They\n"
	"dig small burrows into the ground to hide from\n"
	"predators. Particularly weak-willed specimens\n"
	"will get homesick after leaving a burrow for too\n"
	"long.");

const u8 gCrusterrorPokedexText[] = _(
	"These long serpentine Pokémon cleave through\n"
	"layers of the earth with ease and are very\n"
	"territorial. It is advised to steer clear of the\n"
	"telltale cracked lines and burrow holes that\n"
	"denote Crusterror territory. Crusterritory.");

const u8 gMantacorePokedexText[] = _(
	"Primordial beings that have been alive for\n"
	"millennia. Over those eons, these Pokémon have\n"
	"eroded slowly but surely, leaving only a\n"
	"shrunken core clinging to life. They yearn to be\n"
	"whole again.");

const u8 gGravendorPokedexText[] = _(
	"When a Pokémon challenges their might, they dig\n"
	"a hole in the ground roughly the size of the foe\n"
	"while staring them down. Most competitors flee,\n"
	"though those foolish enough to engage often find\n"
	"themselves six feet under.");

const u8 gGrubblePokedexText[] = _(
	"Grubble are little Pokémon that behave much like\n"
	"human babies. They will evolve into\n"
	"unpredictable and dangerous forms depending on\n"
	"what is stabbed into their cranium.");

const u8 gGracklinPokedexText[] = _(
	"A Gracklin's stones are knifelike and pulsating\n"
	"with an electric charge. They will pierce their\n"
	"adversary with their claws and send a current\n"
	"through their nervous system, resulting in a\n"
	"quick, shocking demise.");

const u8 gShamburgerPokedexText[] = _(
	"They mimic the appearance of burgers to trick\n"
	"those foolish enough to pick up food off of cave\n"
	"floors. They'll try eating anything that gets\n"
	"close enough to them.");

const u8 gFrozhornPokedexText[] = _(
	"Playful but brutish, the young Frozhorn charge\n"
...
const u8 gFrozforcePokedexText[] = _(
	...
	"brutes travel in packs. Vents on their frill\n"
	"blast frosty wind, forming icy horns used in\n"
	"combat. They charge thunderously, breaking ice\n"
	"and earth, smashing through all threats.");

const u8 gStaalnaryPokedexText[] = _(
	"Though looking rather similar to Skarmory,\n"
	"Staalnary are closer relatives to ancient\n"
	"Dragapult. Their similar appearance is merely a\n"
	"quirk of convergent evolution. They are very\n"
	"hostile and hunt in packs of three.");

const u8 gBaromitePokedexText[] = _(
	"Their internal temperature is vital to their\n"
	"survival and must be kept around 350 degrees\n"
	"Fahrenheit. Instead of vets, Baromite pet owners\n"
	"are urged to take them to mechanics to have them\n"
	"fixed.");

const u8 gNapalmitePokedexText[] = _(
	"Napalmite are natural managers and keep a tight\n"
	"schedule. They are extremely popular in homes in\n"
	"wintry regions, as by themselves they will keep\n"
	"a house at a comfortable, even temperature.");

const u8 gStovlarePokedexText[] = _(
	"While often grumpy, Stovlare are known to be\n"
	"helpful to both humans and other Pokémon. Their\n"
	"large mouths bake whatever is kept inside at 400\n"
	"degrees Fahrenheit, and they often cooperate\n"
	"with Celshrioom to make extravagant meals.");

const u8 gOrbaclePokedexText[] = _(
	"Once a toy giving childish prognostications of\n"
	"jovial pursuits, its long use gave psychic life\n"
	"to it. The futures it foresaw became palpable and\n"
	"concrete and slowly seeped with malign intent. A\n"
	"doomsayer, now called, no longer a toy of joy.");

const u8 gNinownPokedexText[] = _(
	"Archaeologists have found figurines resembling\n"
	"Nin'own in ancient ruins. Their erratic\n"
	"movements have been used by physicists to model\n"
	"particle motion.");

const u8 gDegourgePokedexText[] = _(
	"That gravestone, it's following me. I saw them\n"
	"move. I heard the creaking noise it made. Not\n"
	"only that, but I've seen the bits it left\n"
	"behind... the rotten smell it makes...");

const u8 gTuetuerrorPokedexText[] = _(
	"Tueterror are true terrors of the night, picking\n"
	"villages to reign over supremely and feasting\n"
	"upon those who cross them. Their intense\n"
	"gluttony feeds their stomach, where they store\n"
	"all of their ample power.");

const u8 gBaghostPokedexText[] = _(
	"Some say Baghost are the spirits of humans from\n"
	"the Middle Ages who died via the guillotine.\n"
	"Others say they are ectoplasmic balls of energy\n"
	"that made their home in inanimate bags. A third,\n"
	"idiotic camp believes they are birds.");

const u8 gBaghoulPokedexText[] = _(
	"They lurk in abandoned buildings, hooking their\n"
	"tendrils without warning into their prey and\n"
	"dropping onto them with their sacklike skin,\n"
	"consuming their body and spirit. Their bodies\n"
	"are fragile but immune to most elements.");

const u8 gWuvmePokedexText[] = _(
	"Love, a deceptive affliction. As you soak in the\n"
	"decadence of its poison, it spirals into an\n"
	"obsessive affair. Separation from it becomes\n"
	"fear, and attachment is your single impetus.\n"
	"Feeding it your emotions until none remain.");

const u8 gVeeblenPokedexText[] = _(
	"Small and puny. Found in muddy water, they feed\n"
	"on blood, slicing into prey's skin with their\n"
	"three sharp teeth. Though wild Veeblen carry\n"
	"diseases, domestic ones are often used in\n"
	"medical treatment.");

const u8 gMalachreyPokedexText[] = _(
	"Their teeth are made of toxic crystals that can\n"
	"paralyze their prey. Malachrey make their homes\n"
	"in swamps, carving out a den in the mud. They\n"
	"have poor eyesight and rely on sound and smell\n"
	"to locate opponents.");

const u8 gMalmarePokedexText[] = _(
	"Malmare are an extremely dangerous invasive\n"
	"species that can infect and devastate entire\n"
	"ecosystems if not controlled, so they have been\n"
	"completely removed from the wild. Their favorite\n"
	"food is Porygon.");

const u8 gSweetanPokedexText[] = _(
	"Miniscule globs of honey that take orders from\n"
	"apiary creatures only. Amusingly, if a trainer\n"
	"dresses up in a bee costume, this successfully\n"
	"fools Sweetan into giving them undying loyalty.");

const u8 gMelceralbaPokedexText[] = _(
	"A natural defense system utilized by Beedrill\n"
	"and Vespiquen colonies to protect hives. They\n"
	"are believed to be sentient honey, though their\n"
	"brains are more like a string of digital code\n"
	"than anything else found in nature.");

const u8 gBuggoryPokedexText[] = _(
	"Commonly regarded as “roadkill”, Buggory patrol\n"
	"interstate roads and highways seemingly out of\n"
	"boredom, and often are crushed by speeding cars.\n"
	"They are especially hardy, however, and often\n"
	"come out with minimal injury.");

const u8 gZappugPokedexText[] = _(
	"These insectoid Pokémon spend most of their time\n"
	"charging up energy. When they are attacked by\n"
	"foes, they let out a shock that is more intense\n"
	"the longer the Zappug had been charging for. ");

const u8 gPupulzePokedexText[] = _(
	"After a Zappug charges enough energy, it evolves\n"
	"into a Pupulze. Seeking to store even more\n"
	"electrical power, they use the horn atop their\n"
	"head as a lightning rod and wait out in storms\n"
	"to be struck.");

const u8 gRubimizerPokedexText[] = _(
	"Rubimizer come out of their cocoon with the\n"
	"sound of a thunderclap and fly south to breed.\n"
	"Their vibrant pink coloration can attract\n"
	"predators, but they are more than capable of\n"
	"zapping away any threats.");

const u8 gRickshawtyPokedexText[] = _(
	"A lady was lost deep in a taiga where ice-scaled\n"
	"moths take residence. In desperation, she set a\n"
	"bush aflame, the warmth she sought embracing her\n"
	"full. By dawn, there was no forest, no cold to\n"
	"feel, only the ash and ember snow.");

const u8 gTremitePokedexText[] = _(
	"Though they are tiny, Tremite are intelligent\n"
	"and organized, forming a hierarchical society\n"
	"not dissimilar to Ancient Rome in their\n"
	"colonies. When encountering an enemy, they will\n"
	"get into a structured battle formation.");

const u8 gTrohivePokedexText[] = _(
	"A born scout, Trohive will survey forests for\n"
	"their colony and eradicate what they deem to be\n"
	"threats. When your house is circled by one, they\n"
	"are trying to invade it to make it a home for\n"
	"Tremite.");

const u8 gCastermitePokedexText[] = _(
	"The inside of a Castermite's body is filled with\n"
	"dozens of Tremite, honor-bound to protect their\n"
	"general. Colonies living within these beings are\n"
	"noted as being their own civilizations.");

const u8 gEyeslightPokedexText[] = _(
	"They have an uncharacteristically violent\n"
	"disposition for a Pokémon. They attack anything\n"
	"that bewilders them with a weak laser beam\n"
	"produced through their eyeballs.");

const u8 gBeholzerPokedexText[] = _(
	"Their gigantic eye can lock onto fast-moving\n"
	"targets. They then fire many beams at their foe,\n"
	"obliterating it. A single concentrated blast can\n"
	"punch a hole into a mountain.");

const u8 gAstigmorayPokedexText[] = _(
	"Astigmoray are strong and rare Pokémon that\n"
	"dwell in Antarctic waters. They make their homes\n"
	"in drifting icebergs and protect them fiercely\n"
	"with beams shot from their ever-watching iris,\n"
	"which is also their only weak point.");

const u8 gGelebrumPokedexText[] = _(
	"The icicle that pierces through Gelebrum somehow\n"
	"taps into their hidden power. When in caves,\n"
	"they will cause tremors so that more icicles\n"
	"will fall, but unfortunately, not every attempt\n"
	"results in that power being unlocked.");

const u8 gRebrrPokedexText[] = _(
	"Their bodies are made of snow densely packed\n"
	"onto a metal frame. Rebrr roll around to gather\n"
	"more snow, growing larger as they age. Smaller\n"
	"Rebrr will often stack themselves on larger ones\n"
	"as they rest.");

const u8 gFerrofrosPokedexText[] = _(
	"Their midsections are constantly churning,\n"
	"grinding the rocks and slush they've consumed\n"
	"into cement. If cornered, Ferrofros will spit\n"
	"this mixture at foes, which the cold air in\n"
	"their habitats makes it harden almost instantly.");

const u8 gFortifrosPokedexText[] = _(
	"Their fists are as destructive as they are\n"
	"dexterous, making for suitable wrecking balls\n"
	"and carving fine detail alike. In the wild, they\n"
	"build walls of snow and stone to protect their\n"
	"young, so many use them to help in construction.");

const u8 gArctikackPokedexText[] = _(
	"Arctikack are a mountain-dwelling species of\n"
	"primates that have decent cold resistance due to\n"
	"their fur but usually live near hot springs if\n"
	"any are available. They live in medium-sized\n"
	"groups that practice combat with one another.");

const u8 gPrismapupPokedexText[] = _(
	"They're territorial against other Prismapup they\n"
	"deem are too similar to themselves. It is said\n"
	"that Prismapup fur was the origin of an entirely\n"
	"new shade of cyan, though this has been debunked\n"
	"quite ardently.");

const u8 gVividawgPokedexText[] = _(
	"Their coat naturally secretes glitter to mark\n"
	"their territory, which exposes others to harmful\n"
	"microplastics. As such, they are very unpopular\n"
	"pets, though an alternative movement has sprung\n"
	"up that finds them aesthetically pleasing.");

const u8 gKittepupPokedexText[] = _(
	"Oddly, the feline half vocalizes in demanding\n"
	"barks, and the canine half by a soft “mrrp”. They\n"
	"have never been observed apart, and this has led\n"
	"environmentalists to be concerned over the\n"
	"implications of separating them in captivity.");

const u8 gPeckachewPokedexText[] = _(
	"Once Pikachu Fever enraptured the Pokémon\n"
	"world, these previously unseen Pokémon appeared\n"
	"in droves. Most regard them as complete\n"
	"nuisances, but a growing cult following of\n"
	"trainers find their strange behavior endearing.");

const u8 gSkookyPokedexText[] = _(
	"“Spooky Space Kook”\n"
	"Glowing, ghostly tracks lead the gang\n"
	"to an abandoned airfield.\n"
	"TRIVIA: This Pokémon was created due to a\n"
	"dev's love of Scooby-Doo: Night of 100 Frights.");

const u8 gVizaavisoPokedexText[] = _(
	"They are artificial creatures of science, magic,\n"
	"and nature. Vizaaviso wear a mask and a shell\n"
	"that protects them from the evils of the world.\n"
	"They were made to police the streets of an\n"
	"advanced, ancient civilization.");

const u8 gSetatonkrePokedexText[] = _(
	"An Ultra Beast that has arrived here through a\n"
	"wormhole from another world. It displays\n"
	"primordial, feral ferocity, unlike any other\n"
	"known species, and is considered nominally\n"
	"dangerous.");

const u8 gPanzeeheePokedexText[] = _(
	"They live in groups of up to a dozen members,\n"
	"called troupes, with funnier Panzeehee ranking\n"
	"higher. Though they are clumsy, their stretchy\n"
	"arms and rubbery bodies let them swing through\n"
	"trees with ease, regardless.");

const u8 gBaboboPokedexText[] = _(
	"A pair of Babobo head every Panzeehee troupe. A\n"
	"Babobo's sense of humor will shape how its group\n"
	"socializes, as such, different troupes rarely\n"
	"get along.");

const u8 gMogPokedexText[] = _(
...
const u8 gPlaintainPokedexText[] = _(
	"Smug and tricksy, Plaintain will make their\n"
	"homes in the gardens of humans, soaking up\n"
	"nutrients from other plants. If something\n"
	"happens to step near their head, Plaintain will\n"
	"trip them.");

const u8 gMusalordPokedexText[] = _(
	"The pleasant aroma of the Nanab berries on their\n"
	"hands lures in gullible folk, who Musalord then\n"
	"delight in pummeling with a flurry of kicks and\n"
	"chops. They especially love to punt Plantatori.");

const u8 gBurstadPokedexText[] = _(
	"Burstad quite literally burst out of their egg\n"
	"when newly hatched, causing a ruckus to nests\n"
	"unprepared for this outcome. They swim in warm\n"
	"bodies of water, boiling their surroundings.");

const u8 gBlastoadPokedexText[] = _(
	"They hunt for small bug Pokémon like Zappug and\n"
	"send out their long tongues to capture them.\n"
	"Once they swallow their prey, the Pokémon\n"
	"detonate their stomach to dissolve the meal.");

const u8 gExploadPokedexText[] = _(
	"They pound on their belly like a timpani, the\n"
	"tremors riling up their volatile insides when\n"
	"they are ready to finish a battle. Expload\n"
	"specialize in, well, exploding. Specifically,\n"
	"their regenerative stomach.");

const u8 gHagooshPokedexText[] = _(
	"Hagoosh are rarely seen above the abyssal zone.\n"
	"When threatened, they can manipulate the slime\n"
	"they secrete to form an intimidating, powerful\n"
	"body to fight back against their assailants.");

const u8 gDullsodPokedexText[] = _(
	"As their name implies, they are a relative of\n"
	"the Pokémon Sadsod. While they are much more\n"
	"resilient than their cousins, the family's\n"
	"signature lethargy renders them ineffective in\n"
	"battle.");

const u8 gBevolpinPokedexText[] = _(
	"They are cruel, malevolent entities that have\n"
	"emerged from seafloor caverns. The belief that\n"
	"these creatures were harmless out of water was\n"
	"proven incorrect after ecologists, who lacked\n"
	"foresight, introduced them to the surface.");

const u8 gFrankturePokedexText[] = _(
	"Frankture can hop both high and far like an\n"
	"astronaut on the moon, despite their giant mass.\n"
	"In battle, they will crash down, causing a quake\n"
	"to knock their opponent off balance before\n"
	"rolling into them.");

const u8 gGroosePokedexText[] = _(
	"Said to be birthed from dirty oil left to rot,\n"
	"Groose slide around unhindered by most terrain.\n"
	"With the advent of fast-food restaurants, they\n"
	"are an increasingly common sight in big cities.");

const u8 gGreesePokedexText[] = _(
	"Despite being born from the lowest class of\n"
	"food, Greese are beings of dignity. As such,\n"
	"partaking in their “flesh” is an arduous task.\n"
	"However, should you succeed in this, you can\n"
	"expect a heartburn that lasts for months on end.");
...
const u8 gShelebratePokedexText[] = _(
	...
	"Shelebrate twirl around their sticks\n"
	"rhythmically, even when attacking, and can be\n"
	"heard making clicking sounds to keep time. They\n"
	"are exceptionally jovial beings.");

const u8 gMagidashPokedexText[] = _(
	"According to legend, these Pokémon descend from\n"
	"their starry abode every summer solstice's eve\n"
	"in revelry and hunger, igniting wildfires in\n"
	"their wake. Ancient humans began to put out\n"
	"burnt offerings at sunrise to be spared.");

const u8 gSkuldugeryPokedexText[] = _(
	"Born with the smell of mud, wizards living in\n"
	"the deepest marshlands conjure these perplexing\n"
	"entities. They have betrayed their creators,\n"
	"slowly corrupting them into more Skuldugery.");

const u8 gCardictPokedexText[] = _(
	"They will allow predators to capture one of\n"
	"their cards before asking their assailant to\n"
	"name it. If the card is named incorrectly, the\n"
	"cardholder will soon find their brain ablaze,\n"
	"their fate sealed.");

const u8 gPokerlordPokedexText[] = _(
	"Arrogantly looking down upon other Pokémon,\n"
	"these card-like curs engage others in battles of\n"
	"wit and luck. The odds seem fair at first,\n"
	"before being revealed to be largely in the\n"
	"Pokerlord's favor.");
...
const u8 gRetineelPokedexText[] = _(
	"It is said that Retineel dutifully watch out for\n"
	"incoming ships in arctic regions, and send\n"
	"signals to piscine Pokémon in the surrounding\n"
	"waters to vacate the premises.");

const u8 gStuntislaPokedexText[] = _(
	"An erratic presence. They are more mobile than\n"
	"they may appear. Their legs can work as springs,\n"
	"propelling them at high speeds, and their claws\n"
	"course with potent electricity. When Stuntisla\n"
	"punch a foe, shocks ripple through its body.");
#endif