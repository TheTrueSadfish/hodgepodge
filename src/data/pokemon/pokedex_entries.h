const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_GOOPER] =
    {
        .categoryName = _("Goopy"),
        .height = 3,
        .weight = 25,
        .description = gGooperPokedexText,
        .pokemonScale = 530,
        .pokemonOffset = 0, // 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PROFUR] =
    {
        .categoryName = _("Sweeper"),
        .height = 14,
        .weight = 487,
        .description = gProfurPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Heated"),
        .height = 12,
        .weight = 392,
        .description = gCelshrioomPokedexText,
        .pokemonScale = 324,
        .pokemonOffset = 0, // 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Yes Yes"),
        .height = 12,
        .weight = 580,
        .description = gDadalemmaPokedexText,
        .pokemonScale = 287,
        .pokemonOffset = 0, // 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Contender"),
        .height = 11,
        .weight = 328,
        .description = gCrawtendrPokedexText,
        .pokemonScale = 365,
        .pokemonOffset = 0, // 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Pragmatic"),
        .height = 22,
        .weight = 750,
        .description = gOkkamirizoPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    {
        .categoryName = _("Peel Duck"),
        .height = 8,
        .weight = 196,
        .description = gPlantatoriPokedexText,
        .pokemonScale = 369,
        .pokemonOffset = 0, // 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SAPPOD] =
    {
        ...
        .height = 4,
        .weight = 65,
        .description = gSappodPokedexText,
        .pokemonScale = 469,
        .pokemonOffset = 0, // 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SHELBERT] =
    {
        ...
        .height = 6,
        .weight = 115,
        .description = gShelbertPokedexText,
        .pokemonScale = 484,
        .pokemonOffset = 0, // 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Shellington"),
        .height = 11,
        .weight = 240,
        .description = gShelebratePokedexText,
        .pokemonScale = 320,
        .pokemonOffset = 0, // 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Jabbing"),
        .height = 15,
        .weight = 560,
        .description = gStuntislaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 1,
        .trainerScale = 293,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_PLAINTAIN] =
    {
        ...
        .height = 3,
        .weight = 32,
        .description = gPlaintainPokedexText,
        .pokemonScale = 530,
        .pokemonOffset = 0, // 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Banana Tree"),
        .height = 20,
        .weight = 1000,
        .description = gMusalordPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 0,
        .trainerScale = 344,
        .trainerOffset = 7,
    ...
    {
        .categoryName = _("Dirt Frog"),
        .height = 8,
        .weight = 197,
        .description = gBrevatoPokedexText,
        .pokemonScale = 366,
        .pokemonOffset = 0, // 10,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_KELPPY] =
    {
        ...
        .height = 5,
        .weight = 73,
        .description = gKelppyPokedexText,
        .pokemonScale = 432,
        .pokemonOffset = 0, // 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Lagoon"),
        .height = 18,
        .weight = 815,
        .description = gLurkelpPokedexText,
        .pokemonScale = 267,
        .pokemonOffset = 0, // 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    {
        .categoryName = _("Cap Pig"),
        .height = 5,
        .weight = 99,
        .description = gShroomoinkPokedexText,
        .pokemonScale = 432,
        .pokemonOffset = 0, // 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SPORKE] =
    {
        .categoryName = _("Spore Pig"),
        .height = 10,
        .weight = 555,
        .description = gSporkePokedexText,
        .pokemonScale = 305,
        .pokemonOffset = 0, // 8,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Mushroom Pig"),
        .height = 16,
        .weight = 1500,
        .description = gChernoboarPokedexText,
        .pokemonScale = 259,
        .pokemonOffset = 0, // 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_BURSTAD] =
    {
        ...
        .height = 6,
        .weight = 124,
        .description = gBurstadPokedexText,
        .pokemonScale = 369,
        .pokemonOffset = 0, // 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Crackle"),
        .height = 10,
        .weight = 200,
        .description = gBlastoadPokedexText,
        .pokemonScale = 288,
        .pokemonOffset = 0, // 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_EXPLOAD] =
    {
        ...
        .height = 13,
        .weight = 540,
        .description = gExploadPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ICANDESFEN] =
    {
        ...
        .height = 17,
        .weight = 845,
        .description = gIcandesfenPokedexText,
        .pokemonScale = 259,
        .pokemonOffset = 0, // 0,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    {
        .categoryName = _("High Imp"),
        .height = 8,
        .weight = 125,
        .description = gMagidashPokedexText,
        .pokemonScale = 366,
        .pokemonOffset = 0, // 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Purify"),
        .height = 15,
        .weight = 380,
        .description = gSeraphurePokedexText,
        .pokemonScale = 268,
        .pokemonOffset = 0, // 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Hagfish"),
        .height = 2,
        .weight = 3,
        .description = gHagooshPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 0, // 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Sea Spider"),
        .height = 12,
        .weight = 60,
        .description = gWakasukaPokedexText,
        .pokemonScale = 356,
        .pokemonOffset = 0, // 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DULLSOD] =
    {
        ...
        .height = 8,
        .weight = 730,
        .description = gDullsodPokedexText,
        .pokemonScale = 315,
        .pokemonOffset = 0, // 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("NumStation"),
        .height = 18,
        .weight = 1557,
        .description = gOddiowavePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 0,
        .trainerScale = 268,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_WHERML] =
    {
        ...
        .height = 3,
        .weight = 85,
        .description = gWhermlPokedexText,
        .pokemonScale = 530,
        .pokemonOffset = 0, // 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CRUSTERROR] =
    {
        ...
        .height = 25,
        .weight = 3100,
        .description = gCrusterrorPokedexText,
        .pokemonScale = 356,
        .pokemonOffset = 0, // 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SKULDUGERY] =
    {
        ...
        .height = 12,
        .weight = 300,
        .description = gSkuldugeryPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Grave Digger"),
        .height = 26,
        .weight = 3020,
        .description = gGravendorPokedexText,
        .pokemonScale = 266,
        .pokemonOffset = 0, // 3,
        .trainerScale = 399,
        .trainerOffset = 4,   
    ...
    {
        .categoryName = _("Premature"),
        .height = 11,
        .weight = 1105,
        .description = gFrankturePokedexText,
        .pokemonScale = 311,
        .pokemonOffset = 0, // 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GRUBBLE] =
    {
        ...
        .height = 5,
        .weight = 92,
        .description = gGrubblePokedexText,
        .pokemonScale = 432,
        .pokemonOffset = 0, // 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Gemstone"),
        .height = 8,
        .weight = 250,
        .description = gGracklinPokedexText,
        .pokemonScale = 366,
        .pokemonOffset = 0, // 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Pyura"),
        .height = 12,
        .weight = 666,
        .description = gShamburgerPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Small Horned"),
        .height = 9,
        .weight = 315,
        .description = gFrozhornPokedexText,
        .pokemonScale = 338,
        .pokemonOffset = 0, // 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Big Horned"),
        .height = 16,
        .weight = 1025,
        .description = gFrozforcePokedexText,
        .pokemonScale = 259,
        .pokemonOffset = 0, // 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    {
        .categoryName = _("Wyvern Bird"),
        .height = 17,
        .weight = 505,
        .description = gStaalnaryPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 0,
        .trainerScale = 271,
        .trainerOffset = 1,
    ...
    {
        .categoryName = _("Heating"),
        .height = 3,
        .weight = 120,
        .description = gBaromitePokedexText,
        .pokemonScale = 530,
        .pokemonOffset = 0, // 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_NAPALMITE] =
    {
        ...
        .height = 11,
        .weight = 780,
        .description = gNapalmitePokedexText,
        .pokemonScale = 320,
        .pokemonOffset = 0, // 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Broiling"),
        .height = 28,
        .weight = 3105,
        .description = gStovlarePokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 0, // 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Fortune Box"),
        .height = 10,
        .weight = 1680,
        .description = gOrbaclePokedexText,
        .pokemonScale = 300,
        .pokemonOffset = 0, // 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_NINOWN] =
    {
        ...
        .height = 5,
        .weight = 50,
        .description = gNinownPokedexText,
        .pokemonScale = 411,
        .pokemonOffset = 0, // 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Flush"),
        .height = 4,
        .weight = 60,
        .description = gCardictPokedexText,
        .pokemonScale = 491,
        .pokemonOffset = 0, // 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Royal Flush"),
        .height = 7,
        .weight = 142,
        .description = gPokerlordPokedexText,
        .pokemonScale = 365,
        .pokemonOffset = 0, // 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DEGOURGE] =
    {
        ...
        .height = 15,
        .weight = 1325,
        .description = gDegourgePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 0,
        .trainerScale = 269,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_TUETUERROR] =
    {
        ...
        .height = 16,
        .weight = 366,
        .description = gTuetuerrorPokedexText,
        .pokemonScale = 259,
        .pokemonOffset = 0, // 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_BAGHOST] =
    {
        ...
        .height = 8,
        .weight = 12,
        .description = gBaghostPokedexText,
        .pokemonScale = 372,
        .pokemonOffset = 0, // -8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BAGHOUL] =
    {
        ...
        .height = 11,
        .weight = 125,
        .description = gBaghoulPokedexText,
        .pokemonScale = 262,
        .pokemonOffset = 0, // 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_WUVME] =
    {
        .categoryName = _("Obsession"),
        .height = 6,
        .weight = 87,
        .description = gWuvmePokedexText,
        .pokemonScale = 371,
        .pokemonOffset = 0, // 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Bloodsucker"),
        .height = 2,
        .weight = 3,
        .description = gVeeblenPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 0, // 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MALACHREY] =
    {
        ...
        .height = 21,
        .weight = 805,
        .description = gMalachreyPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 1,
        .trainerScale = 365,
        .trainerOffset = 7,
    ...
    [NATIONAL_DEX_MALMARE] =
    {
        ...
        .height = 17,
        .weight = 950,
        .description = gMalmarePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 0,
        .trainerScale = 289,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_SWEETAN] =
    {
        ...
        .height = 2,
        .weight = 80,
        .description = gSweetanPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 0, // 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Hivemind"),
        .height = 25,
        .weight = 800,
        .description = gMelceralbaPokedexText,
        .pokemonScale = 257,
        .pokemonOffset = 0, // 10,
        .trainerScale = 423,
        .trainerOffset = 8,
    ...
    {
        .categoryName = _("Buggular"),
        .height = 11,
        .weight = 335,
        .description = gBuggoryPokedexText,
        .pokemonScale = 316,
        .pokemonOffset = 0, // 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZAPPUG] =
    {
        ...
        .height = 3,
        .weight = 29,
        .description = gZappugPokedexText,
        .pokemonScale = 549,
        .pokemonOffset = 0, // 22,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Rod Pupa"),
        .height = 7,
        .weight = 99,
        .description = gPupulzePokedexText,
        .pokemonScale = 350,
        .pokemonOffset = 0, // 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RUBIMIZER] =
    {
        ...
        .height = 11,
        .weight = 320,
        .description = gRubimizerPokedexText,
        .pokemonScale = 312,
        .pokemonOffset = 0, // 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RICKSHAWTY] =
    {
        ...
        .height = 13,
        .weight = 420,
        .description = gRickshawtyPokedexText,
        .pokemonScale = 272,
        .pokemonOffset = 0, // 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TREMITE] =
    {
        ...
        .height = 1,
        .weight = 6,
        .description = gTremitePokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 0, // 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TROHIVE] =
    {
        ...
        .height = 10,
        .weight = 300,
        .description = gTrohivePokedexText,
        .pokemonScale = 283,
        .pokemonOffset = 0, // 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CASTERMITE] =
    {
        ...
        .height = 25,
        .weight = 9200,
        .description = gCastermitePokedexText,
        .pokemonScale = 257,
        .pokemonOffset = 0, // 10,
        .trainerScale = 423,
        .trainerOffset = 8,
    ...
    [NATIONAL_DEX_EYESLIGHT] =
    {
        ...
        .height = 5,
        .weight = 110,
        .description = gEyeslightPokedexText,
        .pokemonScale = 451,
        .pokemonOffset = 0, // 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_EYERISH] =
    {
        ...
        .height = 5,
        .weight = 310,
        .description = gEyerishPokedexText,
        .pokemonScale = 432,
        .pokemonOffset = 0, // 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RETINEEL] =
    {
        ...
        .height = 13,
        .weight = 960,
        .description = gRetineelPokedexText,
        .pokemonScale = 272,
        .pokemonOffset = 0, // 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ASTIGMORAY] =
    {
        ...
        .height = 20,
        .weight = 5050,
        .description = gAstigmorayPokedexText,
        .pokemonScale = 261,
        .pokemonOffset = 0, // 1,
        .trainerScale = 334,
        .trainerOffset = 4,
    ...
    {
        .categoryName = _("Ice Drop"),
        .height = 6,
        .weight = 88,
        .description = gGelebrumPokedexText,
        .pokemonScale = 455,
        .pokemonOffset = 0, // 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FERROFROS] =
    {
        ...
        .height = 6,
        .weight = 1050,
        .description = gFerrofrosPokedexText,
        .pokemonScale = 356,
        .pokemonOffset = 0, // 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Alpine"),
        .height = 10,
        .weight = 290,
        .description = gArctikackPokedexText,
        .pokemonScale = 305,
        .pokemonOffset = 0, // 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PRISMAPUP] =
    {
        ...
        .height = 3,
        .weight = 135,
        .description = gPrismapupPokedexText,
        .pokemonScale = 530,
        .pokemonOffset = 0, // 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Sparkle Dog"),
        .height = 10,
        .weight = 340,
        .description = gVividawgPokedexText,
        .pokemonScale = 305,
        .pokemonOffset = 0, // 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Amity"),
        .height = 9,
        .weight = 560,
        .description = gKittepupPokedexText,
        .pokemonScale = 338,
        .pokemonOffset = 0, // 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Weird Rat"),
        .height = 4,
        .weight = 60,
        .description = gPeckachewPokedexText,
        .pokemonScale = 479,
        .pokemonOffset = 0, // 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SKOOKY] =
    {
        .categoryName = _("Astronaut"),
        .height = 12,
        .weight = 335,
        .description = gSkookyPokedexText,
        .pokemonScale = 282,
        .pokemonOffset = 0, // 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_VIZAAVISO] =
    {
        ...
        .height = 30,
        .weight = 1850,
        .description = gVizaavisoPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 0, // 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SETATONKRE] =
    {
        ...
        .height = 37,
        .weight = 9999,
        .description = gSetatonkrePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0, // 0,
        .trainerScale = 610,
        .trainerOffset = 17,
    ...
    {
        .categoryName = _("Stretching"),
        .height = 8,
        .weight = 115,
        .description = gPanzeeheePokedexText,
        .pokemonScale = 363,
        .pokemonOffset = 0, // 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BABOBO] =
    {
        .categoryName = _("Rubbery"),
        .height = 12,
        .weight = 203,
        .description = gBaboboPokedexText,
        .pokemonScale = 282,
        .pokemonOffset = 0, // 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GROOSE] =
    {
        ...
        .height = 5,
        .weight = 55,
        .description = gGroosePokedexText,
        .pokemonScale = 432,
        .pokemonOffset = 0, // 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GREESE] =
    {
        .categoryName = _("Geese"),
        .height = 18,
        .weight = 1600,
        .description = gGreesePokedexText,
        .pokemonScale = 267,
        .pokemonOffset = 0, // 0,
        .trainerScale = 286,
        .trainerOffset = 1,
