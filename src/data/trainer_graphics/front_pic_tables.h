const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_DAME] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_AGENT] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_BARRY] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_SMITHY] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_SANE] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_OFFICER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_PHOTOGRAPHER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_THE_HEALER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ELDER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_HOODLUM] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_SOLDIER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_GRILLMEISTER] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(DAME, gTrainerFrontPic_Dame, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(AGENT, gTrainerFrontPic_Agent, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BARRY, gTrainerFrontPic_Barry, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SMITHY, gTrainerFrontPic_Smithy, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SANE, gTrainerFrontPic_Sane, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(OFFICER, gTrainerFrontPic_Officer, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(PHOTOGRAPHER, gTrainerFrontPic_Photographer, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(THE_HEALER, gTrainerFrontPic_TheHealer, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ELDER, gTrainerFrontPic_Elder, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(HOODLUM, gTrainerFrontPic_Hoodlum, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SOLDIER, gTrainerFrontPic_Soldier, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GRILLMEISTER, gTrainerFrontPic_Grillmeister, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(DAME, gTrainerPalette_Dame),
    TRAINER_PAL(AGENT, gTrainerPalette_Agent),
    TRAINER_PAL(BARRY, gTrainerPalette_Barry),
    TRAINER_PAL(SMITHY, gTrainerPalette_Smithy),
    TRAINER_PAL(SANE, gTrainerPalette_Sane),
    TRAINER_PAL(OFFICER, gTrainerPalette_Officer),
    TRAINER_PAL(PHOTOGRAPHER, gTrainerPalette_Photographer),
    TRAINER_PAL(THE_HEALER, gTrainerPalette_TheHealer),
    TRAINER_PAL(ELDER, gTrainerPalette_Elder),
    TRAINER_PAL(HOODLUM, gTrainerPalette_Hoodlum),
    TRAINER_PAL(SOLDIER, gTrainerPalette_Soldier),
    TRAINER_PAL(GRILLMEISTER, gTrainerPalette_Grillmeister),
};
