...
const u8 gMonIcon_Stuntisla[] = INCBIN_U8("graphics/pokemon/stuntisla/icon.4bpp");
...
const u8 gMonIcon_Chernoboar[] = INCBIN_U8("graphics/pokemon/chernoboar/icon.4bpp");
...
const u8 gMonIcon_Skuldugery[] = INCBIN_U8("graphics/pokemon/skuldugery/icon.4bpp");
...
const u8 gMonIcon_Castermite[] = INCBIN_U8("graphics/pokemon/castermite/icon.4bpp");
