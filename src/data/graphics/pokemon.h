...
const u32 gMonFrontPic_Pupulze[] = INCBIN_U32("graphics/pokemon/peblranium/front.4bpp.lz");
const u32 gMonPalette_Pupulze[] = INCBIN_U32("graphics/pokemon/peblranium/normal.gbapal.lz");
const u32 gMonBackPic_Pupulze[] = INCBIN_U32("graphics/pokemon/peblranium/back.4bpp.lz");
const u32 gMonShinyPalette_Pupulze[] = INCBIN_U32("graphics/pokemon/peblranium/shiny.gbapal.lz");
const u8 gMonIcon_Pupulze[] = INCBIN_U8("graphics/pokemon/question_mark/icon.4bpp");
const u8 gMonFootprint_Pupulze[] = INCBIN_U8("graphics/pokemon/000rarities/legendary.1bpp");
