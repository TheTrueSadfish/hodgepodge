const u8 gTrainerClassNames[][18] = {
    ...
    [TRAINER_CLASS_COOLTRAINER] = _("Ace"),
    ...
    [TRAINER_CLASS_DAME] = _("Dame"),
    [TRAINER_CLASS_AGENT] = _("Agent"),
    [TRAINER_CLASS_BARRY] = _("Barry,"),
    [TRAINER_CLASS_SMITHY] = _("Smithy"),
    [TRAINER_CLASS_SANE] = _("Sane"),
    [TRAINER_CLASS_OFFICER] = _("Officer"),
    [TRAINER_CLASS_PHOTOGRAPHER] = _("Photographer"),
    [TRAINER_CLASS_THE_HEALER] = _("The Healer,"),
    [TRAINER_CLASS_ELDER] = _("Elder"),
    [TRAINER_CLASS_HOODLUM] = _("Hoodlum"),
    [TRAINER_CLASS_SOLDIER] = _("Soldier"),
    [TRAINER_CLASS_GRILLMEISTER] = _("Grillmeister"),
    [TRAINER_CLASS_ASSISTANT] = _("Assistant"),
};
