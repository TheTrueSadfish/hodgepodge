...
const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_WILD_ARMS] = _("Wild Arms"),
    [MOVE_PINCER_HOOK] = _("Pincer Hook"),
    [MOVE_PAIN_SPINES] = _("Pain Spines"),
    [MOVE_DARK_HUNGER] = _("Dark Hunger"),
    [MOVE_NIGHT_BEAM] = _("Night Beam"),
    ...
    [MOVE_NON_SEQUITUR] = _("Non Sequitur"),
    [MOVE_BELDAM_BREW] = _("Beldam Brew"),
    [MOVE_ASTRAL_SPIKES] = _("Astral Spikes"),
    [MOVE_WILD_SHUFFLE] = _("Wild Shuffle"),
    [MOVE_UPROOT_EVIL] = _("Uproot Evil"),
    [MOVE_PLIA_BALL] = _("Plia-Ball"),
