...
const u16 gBattleTentTrainerMons_MajorLeague_Legvo[] =
{
    TENT_MAJOR_MON_NETTECATE,
    TENT_MAJOR_MON_SWISQUIRE,
    TENT_MAJOR_MON_PROFUR,
...
const u16 gBattleTentTrainerMons_MinorLeague_Legvo[] =
{
    TENT_MINOR_MON_NETTECATE,
    TENT_MINOR_MON_SWISQUIRE,
    TENT_MINOR_MON_PROFUR,
...
const struct BattleFrontierTrainer gBattleTentTrainers_MajorLeague[NUM_BATTLE_TENT_MAJOR_TRAINERS] = {
    ...
    [BATTLE_TENT_MAJOR_TRAINER_LEGVO] = {
        ...
        .monSet = gBattleTentTrainerMons_MajorLeague_Legvo
    }
};
...
const struct BattleFrontierTrainer gBattleTentTrainers_MinorLeague[NUM_BATTLE_TENT_MINOR_TRAINERS] =
{
    ...
    [BATTLE_TENT_MINOR_TRAINER_LEGVO] = {
        .facilityClass = FACILITY_CLASS_YOUNGSTER,
        .trainerName = _("Legvo"),
        .speechBefore = {EC_WORD_THIS, EC_WORD_PARTY, EC_WORD_GOES, EC_WORD_ON, EC_WORD_FOREVER, EC_WORD_EXCL},
        .speechWin = {EC_WORD_THE, EC_WORD_MUSIC, EC_WORD_PLAYS, EC_WORD_ON, EC_WORD_WITHOUT, EC_WORD_END},
        .speechLose = {EC_WORD_NO, EC_WORD_EXCL, EC_WORD_THE, EC_WORD_MUSIC, EC_WORD_CAN_T, EC_WORD_STOP},
        .monSet = gBattleTentTrainerMons_MinorLeague_Legvo
    }
};
...
const struct TrainerMon gBattleTentMons_MajorLeague[NUM_TENT_MAJOR_MONS] = {
    ...
    [TENT_MAJOR_MON_CAPYBARNA] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_SNORE, MOVE_FOCUS_BLAST, MOVE_FIRE_BLAST, MOVE_BLIZZARD},
    ...
    [TENT_MAJOR_MON_PARAKURI] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_ACROBATICS, MOVE_MANEUVER, MOVE_TAILWIND, MOVE_FLAIL},
    ...
    [TENT_MAJOR_MON_CHAKRARING] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_BURNING_SPIRIT, MOVE_PURGING_FLAMES, MOVE_CALM_MIND, MOVE_PSYSHOCK},
    ...
    [TENT_MAJOR_MON_PLANTATORI] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_PLUCK, MOVE_FEATHER_DANCE, MOVE_TAILWIND, MOVE_PROTECT},
    ...
    [TENT_MAJOR_MON_STUNTISLA] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_VOLT_SWITCH, MOVE_THUNDER_PUNCH, MOVE_CLOSE_COMBAT, MOVE_FOCUS_BLAST},
    ...
    [TENT_MAJOR_MON_SWALHEART] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_LEECH_SEED, MOVE_INGRAIN, MOVE_FINAL_GAMBIT, MOVE_SYRUP_BOMB},
    ...
    [TENT_MAJOR_MON_SMAUGRON] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_RAGING_FURY, MOVE_AMNESIA, MOVE_ROADBLOCK, MOVE_BODY_PRESS},
    ...
    [TENT_MAJOR_MON_SERAPHURE] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_HEAL_BELL, MOVE_COOL_MIST, MOVE_PURIFICATION, MOVE_THUNDER},
    ...
    [TENT_MAJOR_MON_RUSALVOIR] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_OCTOLOCK, MOVE_WITCH_HYMN, MOVE_SNARL, MOVE_STRENGTH_SAP},
    ...
    [TENT_MAJOR_MON_WAKASUKA] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_BANEFUL_BUNKER, MOVE_COUNTER, MOVE_VENOM_DRENCH, MOVE_NEEDLE_ARM},
    ...
    [TENT_MAJOR_MON_XOLHM] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_STORM_CHASE, MOVE_SEARING_SHOT, MOVE_STORM_FURY, MOVE_HEX},
    ...
    [TENT_MAJOR_MON_LUXSTROBE] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_FIREWORK_CRASH, MOVE_WILD_CHARGE, MOVE_HEAD_SMASH, MOVE_HOWL},
    ...
    [TENT_MAJOR_MON_CRUSTERROR] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_BREAKING_SWIPE, MOVE_SHED_TAIL, MOVE_BULLDOZE, MOVE_FISSURE},
    ...
    [TENT_MAJOR_MON_WATCHAUGUR] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_CALM_MIND, MOVE_HYPNOSIS, MOVE_FOCUS_BLAST, MOVE_RECOVER},
    ...
    [TENT_MAJOR_MON_BUGGORY] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_FIRST_IMPRESSION, MOVE_POUNCE, MOVE_HIT_N_RUN, MOVE_LUCKY_CHANT},
    ...
    [TENT_MAJOR_MON_RICKSHAWTY] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_EMBER_SNOW, MOVE_INFERNAL_PARADE, MOVE_SILVER_WIND, MOVE_STICKY_WEB},
    ...
    [TENT_MAJOR_MON_DRAGONG] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_CASTLE_CRASH, MOVE_DRAGON_DANCE, MOVE_DRACO_METEOR, MOVE_SCALE_SHOT},
    ...
    [TENT_MAJOR_MON_REGIWYRM] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_INVERSION, MOVE_FILLET_AWAY, MOVE_DRAGON_ENERGY, MOVE_LIFE_DEW},
    ...
    [TENT_MAJOR_MON_ASTIGMORAY] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_FREEZING_GLARE, MOVE_MEAN_LOOK, MOVE_BLIZZARD, MOVE_RAZOR_BEAM},
    ...
    [TENT_MAJOR_MON_COORSE] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_ICE_HAMMER, MOVE_MEGAHORN, MOVE_HORN_LEECH, MOVE_DRAGON_HAMMER},
    ...
    [TENT_MAJOR_MON_SKOOKY] = {
        ...
        .ev = TRAINER_PARTY_EVS(85, 85, 85, 85, 85, 85),
        .lvl = 50,
        .moves = {MOVE_GAMMA_RAY, MOVE_GLIMMER, MOVE_MOONLIGHT, MOVE_SPOOK},
