...
extern const u8 BattleScript_AtkSpDefUp[];
...
extern const u8 BattleScript_PelagicLightsActivates[];
...
extern const u8 BattleScript_SpaceCrookActivates[];
...
extern const u8 BattleScript_CovenLightsLowersDefenderStat[];
...
extern const u8 BattleScript_MoveEffectTarShot[];
extern const u8 BattleScript_MoveEffectFreshWhip[];
...
extern const u8 BattleScript_ScriptingAbilityHeal[];
...
extern const u8 BattleScript_DefenseCurlOnSwitchIn[];
extern const u8 BattleScript_JustCurlOnSwitchIn[];
...
extern const u8 BattleScript_SandSlipEndTurn[];
...
extern const u8 BattleScript_NonSequiturSetUp[];
extern const u8 BattleScript_NonSequiturFrostbite[];
extern const u8 BattleScript_NonSequiturToxic[];
extern const u8 BattleScript_NonSequiturParalyze[];
extern const u8 BattleScript_NonSequiturSleep[];
extern const u8 BattleScript_NonSequiturRet[];
extern const u8 BattleScript_DefDownSpeedUp[];
extern const u8 BattleScript_SelfSpeedDown[];
extern const u8 BattleScript_SelfSpeedDown2[];
extern const u8 BattleScript_ResetUserStats[];
extern const u8 BattleScript_DropSpikes[];
...
extern const u8 BattleScript_FilthmongerActivates[];
...
extern const u8 BattleScript_DaringDeedActivates[];
...
extern const u8 BattleScript_PaintedHazardStealthRock[];
extern const u8 BattleScript_PaintedHazardSpikes[];
...
extern const u8 BattleScript_MoveEffectStockpileAway[];
...
extern const u8 BattleScript_InfectionExtraDamage[];
...
extern const u8 BattleScript_DefenderUsedAnExtraMoveFreshWhip[];
extern const u8 BattleScript_DefenderExplodedUsedAnExtraMove[];
extern const u8 BattleScript_AttackerUsedAnExtraMove[];
extern const u8 BattleScript_AttackerUsedAnExtraMoveStatus[];
